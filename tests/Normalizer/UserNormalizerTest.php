...
class UserNormalizerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->normalizer = new UserNormalizer($userRolesTextResolver, $userUrlResolver, $translator);
    ...
    public function testNormalize($context, $expectedResult)
    {
        ...
        $result = $this->normalizer->normalize($user, null, $context);
    ...
    {
        $this->assertTrue($this->normalizer->supportsNormalization(new User(), 'csv', [BaseNormalizer::IS_EXPORT_NORMALIZER => true]));
        $this->assertFalse($this->normalizer->supportsNormalization(new User(), 'csv'));
