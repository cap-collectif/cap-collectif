...
describe('Organization Questionnaire', () => {
  ...
  it('Questionnaire BO - CRUD', () => {
    ...
    cy.wait('@QuestionnaireListQuery', { timeout: 10000 })
    ...
    cy.wait('@CreateQuestionnaireMutation', { timeout: 10000 })
    // update questionnaire
    cy.wait('@QuestionnaireAdminPageQuery', { timeout: 10000 })
    // add section
    ...
    cy.wait('@UpdateQuestionnaireConfigurationMutation', { timeout: 10000 })
