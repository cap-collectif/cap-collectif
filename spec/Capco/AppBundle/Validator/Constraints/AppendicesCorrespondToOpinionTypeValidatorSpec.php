...
class AppendicesCorrespondToOpinionTypeValidatorSpec extends ObjectBehavior
{
    ...
    public function it_should_add_violation_if_there_is_an_appendice_a_not_available_type(
        Opinion $opinion,
    ...
    public function it_should_not_add_violation_if_there_is_appendices_for_available_type(
        Opinion $opinion,
        OpinionType $opinionType,
    ...
    public function it_should_not_add_violation_if_there_is_no_opinion_appendices(
        Opinion $opinion,
        AppendicesCorrespondToOpinionType $constraint,
        ExecutionContextInterface $context,
        ConstraintViolationBuilderInterface $builder
