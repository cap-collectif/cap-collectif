...
class FormattedValueResponseTypeResolverSpec extends ObjectBehavior
{
    ...
    public function it_should_correctly_return_a_comma_separated_string_when_value_is_a_json_with_other_answer_not_specified(
    ...
    public function it_should_correctly_return_a_comma_separated_string_when_value_is_a_json_with_other_answer_is_specified(
        ValueResponse $response
    ): void {
        $value = <<<'EOF'
        ...
        $this($response)->shouldReturn(
            "Incohérente, Que de la publicité (mensongère en plus !), L'autre réponse"
        );
    }

    public function it_should_correcty_return_a_value_stripped_off_html_tags_when_it_has_html_tags(
        ValueResponse $response
    ): void {
        $value = <<<'EOF'
    ...
    public function it_should_correctly_return_a_string_when_value_is_a_json_with_only_one_answer_specified(
        ValueResponse $response
    ): void {
        $value = <<<'EOF'
    ...
    public function it_should_correctly_return_a_string_when_value_is_a_json_with_only_other_answer_specified(
        ValueResponse $response
    ): void {
        $value = <<<'EOF'
