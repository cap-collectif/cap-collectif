...
{
    function it_should_create_account_for_a_validated_paris_user(UserManager $manager, OpenAmClient $client, User $user)
    {
    ...
    function it_should_not_create_account_for_a_not_validated_paris_user(UserManager $manager, OpenAmClient $client)
    {
