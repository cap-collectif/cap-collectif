...
@task
def sign_ssl():
    local('sudo security add-trusted-cert -d -r trustRoot -k /Library/Keychains/System.keychain %s' % env.real_fabfile[:-10] + "infrastructure/services/local/nginx/ssl/capco.crt")
