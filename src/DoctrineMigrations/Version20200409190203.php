...
final class Version20200409190203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE status CHANGE step_id step_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\''
        );
        $this->addSql(
            'ALTER TABLE status ADD CONSTRAINT FK_7B00651C73B21E9C FOREIGN KEY (step_id) REFERENCES step (id)'
        );
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status DROP FOREIGN KEY FK_7B00651C73B21E9C');
        $this->addSql(
            'ALTER TABLE status CHANGE step_id step_id CHAR(36) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci` COMMENT \'(DC2Type:guid)\''
        );
        $this->addSql(
