 ...
 */
final class Version20190731085647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE opinion CHANGE step_id consultation_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\''
        );
        $this->addSql(
            'ALTER TABLE opinion ADD CONSTRAINT FK_AB02B02762FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id)'
        );
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE opinion CHANGE consultation_id step_id CHAR(36) DEFAULT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\''
        );
        $this->addSql(
