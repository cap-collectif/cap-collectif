 ...
 */
final class Version20200106104037 extends AbstractMigration
{
    public static $sourceCategories = [];
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE source_category (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, isEnabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB'
        );
        $this->addSql('DROP TABLE category');
        $this->addSql('DROP INDEX IDX_5F8A7F7312469DE2 ON source');
        $this->addSql(
            'ALTER TABLE source CHANGE category_id source_category_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\''
        );
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE source CHANGE source_category_id category_id CHAR(36) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci` COMMENT \'(DC2Type:guid)\''
        );
        $this->addSql(
    ...
    public function postUp(Schema $schema): void
    {
        foreach (static::$sourceCategories as $sourceCategory) {
            $this->connection->insert('source_category', $sourceCategory);
        }
    }
}
