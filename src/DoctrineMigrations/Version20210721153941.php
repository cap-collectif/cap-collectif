...
final class Version20210721153941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE questionnaire ADD owner_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE questionnaire ADD CONSTRAINT FK_7A64DAF7E3C61F9 FOREIGN KEY (owner_id) REFERENCES fos_user (id)');
