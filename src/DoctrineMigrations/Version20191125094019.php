...
final class Version20191125094019 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema): void
    {
        ...
        foreach ($posts as $post) {
            $this->connection->insert('blog_post_translation', [
        ...
        $this->connection->exec(
            'ALTER TABLE blog_post DROP title, DROP abstract, DROP slug, DROP body, DROP meta_description'
        );
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE blog_post ADD title VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, ADD abstract LONGTEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, ADD slug VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, ADD body LONGTEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, ADD meta_description VARCHAR(160) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`'
        );
