...
class FeaturesCategoryResolver
{
    protected static $categories = array(
        ...
        'settings.modules' => [
            'conditions' => [],
            'features' => ['blog', 'calendar', 'ideas', 'versions', 'themes', 'registration', 'members_list', 'reporting', 'newsletter', 'share_buttons', 'login_facebook', 'login_gplus', 'login_twitter', 'search'],
        ],
