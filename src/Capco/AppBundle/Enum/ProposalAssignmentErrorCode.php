...
class ProposalAssignmentErrorCode implements EnumType
{
    ...
    public const ACCESS_DENIED_TO_REVOKE_DECISION_MAKER = 'ACCESS_DENIED_TO_REVOKE_DECISION_MAKER';
    public const ACCESS_DENIED_TO_ASSIGN_DECISION_MAKER = 'ACCESS_DENIED_TO_ASSIGN_DECISION_MAKER';
