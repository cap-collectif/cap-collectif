...
final class CustomOrderFilesLocator implements FixtureLocatorInterface
{
    ...
    private function installDevFixtures(): array
    {
        return [
            ...
            $this->fixturesDir . 'Dev/ProjectTab.yaml',
            $this->fixturesDir . 'Dev/ProjectTabNewsItem.yaml',
            $this->fixturesDir . 'Dev/ProjectTabEventItem.yaml',
            ...
            $this->fixturesDir . 'Dev/MailingListUser.yaml',
