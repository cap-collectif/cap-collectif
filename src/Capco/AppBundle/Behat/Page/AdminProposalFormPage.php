...
class AdminProposalFormPage extends Page
{
    ...
    protected $path = 'admin/capco/app/proposalform/{proposalformpageid}/edit';
    ...
    public function clickSaveProposalFormButton($tab)
    {
    ...
    public function clickOnButtonOrRadio($element)
    {
        $this->getElement($element)->click();
    }
}
