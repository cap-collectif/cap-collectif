...
class OpinionPage extends Page
{
    ...
    public $elements = [
        ...
        'argument vote button in closed step' => '#arg-201 .argument__btn--vote',
        ...
        'source edit button' => '#source-30 .source__btn--edit',
        ...
        'source delete button' => '#source-30 .source__btn--delete',
        'source confirm delete button' => '#confirm-opinion-source-delete',
        'source report button' => '#source-30 .source__btn--report',
    ];
