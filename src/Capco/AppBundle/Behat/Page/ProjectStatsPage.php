...
class ProjectStatsPage extends Page
{
    ...
    public $elements = [
        'theme stats items' => '#stats-23-themes .stats__list__row',
        'district stats items' => '#stats-23-districts .stats__list__row',
        'district stats modal items' => '#stats-modal-23-districts .stats__list__row',
        'district stats show more button' => '#stats-23-districts .stats__all-button',
