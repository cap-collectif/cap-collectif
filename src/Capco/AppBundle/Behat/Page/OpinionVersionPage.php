...
class OpinionVersionPage extends Page
{
    ...
    public $elements = [
        ...
        'argument edit button' => '#arg-2 .argument__btn--edit',
        ...
        'argument delete button' => '#arg-2 .argument__btn--delete',
        'argument confirm delete button' => '#confirm-argument-delete',
        'argument votes counter' => '#arg-2 .opinion__votes-nb',
        'argument vote button' => '#arg-2 .argument__btn--vote',
        'argument vote button in closed step' => '#arg-210 .argument__btn--vote',
        'argument report button' => '#arg-2 .argument__btn--report',
        // Sources
