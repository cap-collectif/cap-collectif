...
class ApiContext extends ApplicationContext
{
    ...
    /**
     * @When I am logged in to api as user_with_phone_not_sms_confirmed
     */
    public function iAmLoggedInToApiAsUserWithPhoneNotSmsConfirmed()
    {
        $this->createAuthenticatedClient('user_with_phone_not_sms_confirmed@test.com', 'user_with_phone_not_sms_confirmed');
    }
    ...
    /**
     * @When I am logged in to api as user_with_code_not_sms_confirmed
     */
    public function iAmLoggedInToApiAsUserWithSmsCode()
    {
        $this->createAuthenticatedClient('user_with_code_not_sms_confirmed@test.com', 'user_with_code_not_sms_confirmed');
    }
