...
abstract class AbstractStep implements DisplayableInBOInterface, TimeRangeable
{
    ...
    /**
     * For steps created in the new backoffice the slug is generated by StepSavedEvent it allows us to have steps with the same label within a project, we keep Gedmo for the legacy page.
     *
