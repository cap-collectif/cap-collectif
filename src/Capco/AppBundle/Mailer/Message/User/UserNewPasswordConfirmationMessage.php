...
final class UserNewPasswordConfirmationMessage extends AbstractExternalMessage
{
    public const SUBJECT = 'email.notification.password.change.subject';
    public const TEMPLATE = '@CapcoMail/confirmPasswordChange.html.twig';
    public const FOOTER = '';
