...
final class QuestionnaireReplyUpdateAdminMessage extends AbstractAdminMessage
{
    public const SUBJECT = 'email.notification.questionnaire.reply.subject.update';
