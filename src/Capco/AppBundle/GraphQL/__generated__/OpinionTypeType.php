    ...
    public function __construct(ConfigProcessor $configProcessor, GlobalVariables $globalVariables = null)
    {
        $configLoader = function(GlobalVariables $globalVariable) {
            ...
            'fields' => function () use ($globalVariable) {
                ...
                'arguments' => [
                    'type' => Type::listOf($globalVariable->get('typeResolver')->resolve('Argument')),
                    'args' => [
                        [
                            'name' => 'type',
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["proposition_arguments", array(0 => $value, 1 => $args)]);
                    },
            ...
            'interfaces' => function () use ($globalVariable) {
                return [$globalVariable->get('typeResolver')->resolve('Contribution'), $globalVariable->get('typeResolver')->resolve('TrashableContribution'), $globalVariable->get('typeResolver')->resolve('ContributionWithAuthor'), $globalVariable->get('typeResolver')->resolve('EditableContribution')];
            },
            'isTypeOf' => null,
            'resolveField' => null,
        ];
