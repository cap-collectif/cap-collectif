 ...
 */
final class ArgumentVoteType extends ObjectType implements GeneratedTypeInterface
{
    const NAME = 'ArgumentVote';
    ...
    public function __construct(ConfigProcessor $configProcessor, GlobalVariables $globalVariables = null)
    {
        $configLoader = function(GlobalVariables $globalVariable) {
            ...
            'interfaces' => function () use ($globalVariable) {
                return [$globalVariable->get('typeResolver')->resolve('Vote'), $globalVariable->get('typeResolver')->resolve('Publishable')];
            },
            'isTypeOf' => null,
            'resolveField' => null,
        ];
