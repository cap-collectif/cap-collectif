    ...
    public function __construct(ConfigProcessor $configProcessor, GlobalVariables $globalVariables = null)
    {
        $configLoader = function(GlobalVariables $globalVariable) {
            ...
            'fields' => function () use ($globalVariable) {
                ...
                'parent' => [
                    'type' => $globalVariable->get('typeResolver')->resolve('Comment'),
                    'args' => [
                    ],
                    'resolve' => null,
                    'description' => null,
                ...
                'answers' => [
                    'type' => Type::nonNull(Type::listOf($globalVariable->get('typeResolver')->resolve('Comment'))),
                    'args' => [
                    ],
                    'resolve' => null,
                    'description' => null,
                ...
                'authorIp' => [
                    'type' => $globalVariable->get('typeResolver')->resolve('IP'),
                    'args' => [
                    ],
                    'resolve' => null,
                    'description' => null,
                ...
                'publicationStatus' => [
                    'type' => Type::nonNull($globalVariable->get('typeResolver')->resolve('CommentPublicationStatus')),
                    'args' => [
                    ],
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\Comment\\CommentPublicationStatusResolver", array(0 => $value)]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'reportings' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\Comment\\CommentReportingsResolver", array(0 => $value, 1 => $args)]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'votes' => [
                    'type' => Type::nonNull($globalVariable->get('typeResolver')->resolve('CommentVoteConnection')),
                    'args' => [
                        [
                            'name' => 'after',
                            'type' => Type::string(),
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\Comment\\CommentVotesResolver", array(0 => $value, 1 => $args)]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'viewerHasVote' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $value->userHasVote(\Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser($globalVariable));
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'viewerVote' => [
                    'type' => $globalVariable->get('typeResolver')->resolve('CommentVote'),
                    'args' => [
                    ],
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $value->userGetVote(\Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser($globalVariable));
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'editUrl' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\Comment\\CommentEditUrlResolver", array(0 => $value)]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
            ...
            'interfaces' => function () use ($globalVariable) {
                return [$globalVariable->get('typeResolver')->resolve('Node'), $globalVariable->get('typeResolver')->resolve('Publishable'), $globalVariable->get('typeResolver')->resolve('Reportable'), $globalVariable->get('typeResolver')->resolve('Contribution'), $globalVariable->get('typeResolver')->resolve('Commentable')];
            },
            'isTypeOf' => null,
            'resolveField' => null,
        ];
