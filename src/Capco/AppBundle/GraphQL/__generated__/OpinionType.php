    ...
    public function __construct(ConfigProcessor $configProcessor, GlobalVariables $globalVariables = null)
    {
        $configLoader = function(GlobalVariables $globalVariable) {
            ...
            'fields' => function () use ($globalVariable) {
                ...
                'step' => [
                    'type' => Type::nonNull($globalVariable->get('typeResolver')->resolve('InternalConsultation')),
                    'args' => [
                    ],
                    'resolve' => null,
                    'description' => null,
                ...
                'versions' => [
                    'type' => Type::nonNull($globalVariable->get('typeResolver')->resolve('VersionConnection')),
                    'args' => [
                        [
                            'name' => 'after',
                            'type' => Type::string(),
                ...
                'viewerVersionsUnpublished' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\Opinion\\OpinionViewerVersionsUnpublishedResolver", array(0 => $value, 1 => $args, 2 => \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser($globalVariable))]);
                    },
                ...
                'modals' => [
                    'type' => Type::listOf($globalVariable->get('typeResolver')->resolve('OpinionModal')),
                    'args' => [
                    ],
                    'resolve' => null,
                    'description' => null,
                ...
                'appendices' => [
                    'type' => Type::listOf($globalVariable->get('typeResolver')->resolve('Appendix')),
                    'args' => [
                    ],
                    'resolve' => null,
                    'description' => null,
