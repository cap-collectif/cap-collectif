        ...
        $configLoader = function(GlobalVariables $globalVariable) {
            ...
            'fields' => function () use ($globalVariable) {
                ...
                'proposals' => [
                    ...
                    'args' => [
                        ...
                        [
                            ...
                            'type' => Type::boolean(),
                            'description' => 'Include unpublished proposals ?',
                        ],
                    ],
                ...
                'summaryHelpText' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormSummaryHelpTextResolver", array(0 => $value)]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'contribuable' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormViewerCanContributeResolver", array(0 => $value, 1 => \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser($globalVariable))]);
                    },
                ...
                'districts' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormDistrictsResolver", array(0 => $value, 1 => $args["order"])]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'questions' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormQuestionsResolver", array(0 => $value)]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'url' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormUrlResolver", array(0 => $value)]);
                    },
                ...
                'notificationsConfiguration' => [
                    'type' => Type::nonNull($globalVariable->get('typeResolver')->resolve('NotificationsConfiguration')),
                    'args' => [
                    ],
                    'resolve' => null,
                    'description' => null,
                ...
                'evaluationForm' => [
                    'type' => $globalVariable->get('typeResolver')->resolve('EvaluationForm'),
                    'args' => [
                    ],
                    'resolve' => null,
                ...
                'step' => [
                    'type' => $globalVariable->get('typeResolver')->resolve('CollectStep'),
                    'args' => [
                    ],
                    'resolve' => null,
