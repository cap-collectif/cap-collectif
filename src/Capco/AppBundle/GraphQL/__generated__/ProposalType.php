        ...
        $configLoader = function(GlobalVariables $globalVariable) {
            ...
            'fields' => function () use ($globalVariable) {
                ...
                'responses' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\Proposal\\ProposalResponsesResolver", array(0 => $value, 1 => \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser($globalVariable))]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
                ...
                'comments' => [
                    ...
                    'resolve' => function ($value, $args, $context, ResolveInfo $info) use ($globalVariable) {
                        return $globalVariable->get('resolverResolver')->resolve(["Capco\\AppBundle\\GraphQL\\Resolver\\Proposal\\ProposalCommentsResolver", array(0 => $value, 1 => $args)]);
                    },
                    'description' => null,
                    'deprecationReason' => null,
                    'complexity' => null,
            ...
            'interfaces' => function () use ($globalVariable) {
                return [$globalVariable->get('typeResolver')->resolve('Node'), $globalVariable->get('typeResolver')->resolve('Contribution'), $globalVariable->get('typeResolver')->resolve('Publishable'), $globalVariable->get('typeResolver')->resolve('Reportable'), $globalVariable->get('typeResolver')->resolve('Trashable')];
            },
            'isTypeOf' => null,
            'resolveField' => null,
        ];
