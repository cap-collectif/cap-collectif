...
class IndexBuilder
{
     ...
     * @return array
     */
    public function cleanOldIndices()
    {
     ...
     * @return string
     */
    public function getLiveSearchIndexName()
    {
     ...
     * @return Index
     */
    public function getLiveSearchIndex()
    {
     ...
     * @return string
     */
    public function getLiveIndexingIndexName()
    {
     ...
     */
    public function markAsLive(Index $index)
    {
        $data = ['actions' => []];
