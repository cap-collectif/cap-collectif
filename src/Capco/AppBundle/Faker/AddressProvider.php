...
final class AddressProvider extends BaseProvider
{
    ...
    public function __construct(Generator $generator, Generator $faker)
    {
        parent::__construct($generator);
        $this->faker = $faker;
    }

    public function generateAddress(array $latitudeConfig = [self::IDF_MIN_LATITUDE, self::IDF_MAX_LATITUDE],
