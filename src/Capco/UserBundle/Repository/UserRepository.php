...
class UserRepository extends EntityRepository
{
    public function findConsultationSourceContributorsWithCount(Consultation $consultation)
    {
        $qb = $this->createQueryBuilder('u')
                   ...
                   ->leftJoin('u.sources', 'sources', 'WITH', 'sources.isEnabled = 1 AND sources.isTrashed = 0')
                   ->leftJoin('sources.Opinion', 'sources_opinion', 'WITH', 'sources_opinion.isEnabled = 1 AND sources_opinion.isTrashed = 0')
    ...
    public function findConsultationArgumentContributorsWithCount(Consultation $consultation)
    {
        $qb = $this->createQueryBuilder('u')
                   ...
                   ->leftJoin('u.arguments', 'arguments', 'WITH', 'arguments.isEnabled = 1 AND arguments.isTrashed = 0')
                   ->leftJoin('arguments.opinion', 'arguments_opinion', 'WITH', 'arguments_opinion.isEnabled = 1 AND arguments_opinion.isTrashed = 0')
    ...
    public function findConsultationOpinionContributorsWithCount(Consultation $consultation)
    {
        $qb = $this->createQueryBuilder('u')
                    ...
                    ->leftJoin('u.opinions', 'opinions', 'WITH', 'opinions.isEnabled = 1 AND opinions.isTrashed = 0')
    ...
    public function findConsultationOpinionVotersWithCount(Consultation $consultation)
    {
        $qb = $this->createQueryBuilder('u')
                    ...
                    ->leftJoin('opinions_votes.opinion', 'opinions_votes_opinion', 'WITH', 'opinions_votes_opinion.isEnabled = 1 AND opinions_votes_opinion.isTrashed = 0')
