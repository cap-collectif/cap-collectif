...
// copy paste of http://cgit.drupalcode.org/drupal/plain/includes/password.inc?id=7.35
// minus variable_get
...
function drupal_random_bytes($count)
{
    ...
    if ($missing_bytes > 0) {
        ...
        if ($has_openssl) {
            ...
            throw new \Exception('openssl must be installed');
        }
...
class DrupalEncoder implements PasswordEncoderInterface
{
    public function encodePassword($raw, $salt)
    {
        return user_hash_password($raw);
    }
