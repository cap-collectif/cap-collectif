                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\Step\\CollectStepProposalResolver",
                                                array(
                                                    0 => $value,
                                                    1 => $args,
                                                    2 =>
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "query_get_draft_proposals_for_user_in_step",
                                                array(
                                                    0 => $value,
                                                    1 =>
                                                        \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser(
                ...
                'interfaces' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            $globalVariable->get('typeResolver')->resolve('Step'),
