                    ...
                    function () use ($globalVariable) {
                        return [
                            ...
                            'show_url' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["proposition_url", array(0 => $value)]);
                                    },
                            ...
                            'type' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable->get('typeResolver')->resolve('OpinionType')
                                    ),
                                'args' => [],
                                'resolve' => null,
                                'description' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "proposition_argumentsCountAgainst",
                                                array(0 => $value),
                                            ]);
                                    },
                            ...
                            'votes' => [
                                'type' =>
                                    Type::listOf(
                                        $globalVariable->get('typeResolver')->resolve('OpinionVote')
                                    ),
                                'args' => [
                                    [
                                        'name' => 'first',
                            ...
                            'body' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable->get('typeResolver')->resolve('HTML')
                                    ),
                                'args' => [],
                                'resolve' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\Opinion\\OpinionArgumentsResolver",
                                                array(0 => $value, 1 => $args),
                                            ]);
                                    },
                            ...
                            'versions' => [
                                'type' =>
                                    Type::listOf(
                                        $globalVariable->get('typeResolver')->resolve('Version')
                                    ),
                                'args' => [],
                                'resolve' => null,
                            ...
                            'sources' => [
                                'type' =>
                                    Type::listOf(
                                        $globalVariable->get('typeResolver')->resolve('Source')
                                    ),
                                'args' => [],
                                'resolve' => null,
                            ...
                            'section' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable->get('typeResolver')->resolve('Section')
                                    ),
                                'args' => [],
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["proposition_section", array(0 => $value)]);
                                    },
                            ...
                            'reportings' => [
                                'type' =>
                                    Type::listOf(
                                        $globalVariable->get('typeResolver')->resolve('Reporting')
                                    ),
                                'args' => [],
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                ...
                'interfaces' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            $globalVariable->get('typeResolver')->resolve('Argumentable'),
                            $globalVariable->get('typeResolver')->resolve('Contribution'),
                            $globalVariable->get('typeResolver')->resolve('TrashableContribution'),
                            $globalVariable->get('typeResolver')->resolve('ContributionWithAuthor'),
                            $globalVariable->get('typeResolver')->resolve('EditableContribution'),
                        ];
                    },
                'isTypeOf' => null,
                'resolveField' => null,
