                ...
                'fields' =>
                    function () use ($globalVariable) {
                        return [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ...
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormProposalsResolver",
                                                array(
                                                    0 => $value,
                                                    1 => $args,
                                                    2 =>
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormSummaryHelpTextResolver",
                                                array(0 => $value),
                                            ]);
                                    },
                                'description' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormCategoriesResolver",
                                                array(0 => $value),
                                            ]);
                                    },
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormDistrictsResolver",
                                                array(0 => $value, 1 => $args["order"]),
                                            ]);
                                    },
                                'description' => null,
                                'deprecationReason' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormQuestionsResolver",
                                                array(0 => $value),
                                            ]);
                                    },
                                'description' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\ProposalForm\\ProposalFormUrlResolver",
                                                array(0 => $value),
                                            ]);
                                    },
                            ...
                            'notificationsConfiguration' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable
                                            ->get('typeResolver')
                                            ->resolve('NotificationsConfiguration')
                                    ),
                                'args' => [],
                                'resolve' => null,
                                'description' => null,
                            ...
                            'evaluationForm' => [
                                'type' =>
                                    $globalVariable->get('typeResolver')->resolve('EvaluationForm'),
                                'args' => [],
                                'resolve' => null,
                            ...
                            'step' => [
                                'type' =>
                                    $globalVariable->get('typeResolver')->resolve('CollectStep'),
                                'args' => [],
                                'resolve' => null,
