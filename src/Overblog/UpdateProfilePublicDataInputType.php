 ...
 */
final class UpdateProfilePublicDataInputType extends InputObjectType
                ...
                'fields' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            'userType' => ['type' => Type::id(), 'description' => 'Your user type'],
                            'biography' => [
                                'type' => Type::string(),
                            ...
                            'media' => ['type' => Type::id(), 'description' => 'Current media id'],
