 ...
 */
final class UpdateProfilePersonalDataInputType extends InputObjectType
    implements GeneratedTypeInterface
{
                ...
                'fields' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            'city' => ['type' => Type::string(), 'description' => 'Your city'],
                            'zipCode' => [
                                'type' => Type::string(),
                            ...
                            'email' => ['type' => Type::string(), 'description' => 'Your email'],
