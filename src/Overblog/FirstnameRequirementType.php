                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ...
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\Requirement\\ViewerMeetsTheRequirementResolver",
                                                array(
                                                    0 => $value,
                                                    1 =>
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\Requirement\\RequirementViewerValueResolver",
                                                array(
                                                    0 => $value,
                                                    1 =>
                                                        \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser(
                ...
                'interfaces' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            $globalVariable->get('typeResolver')->resolve('Requirement'),
                        ];
                    },
                'isTypeOf' => null,
                'resolveField' => null,
