                ...
                'serialize' =>
                    function () use ($globalVariable) {
                        return call_user_func_array(
                            ['Capco\\AppBundle\\GraphQL\\Type\\CssJSONType', 'serialize'],
                            func_get_args()
                        );
                    },
                'parseValue' =>
                    function () use ($globalVariable) {
                        return call_user_func_array(
                            ['Capco\\AppBundle\\GraphQL\\Type\\CssJSONType', 'parseValue'],
                            func_get_args()
                        );
                    },
                'parseLiteral' =>
                    function () use ($globalVariable) {
                        return call_user_func_array(
                            ['Capco\\AppBundle\\GraphQL\\Type\\CssJSONType', 'parseLiteral'],
                            func_get_args()
                        );
                    },
            ];
