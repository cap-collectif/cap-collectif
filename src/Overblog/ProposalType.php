                ...
                'fields' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            'related' => [
                                'type' =>
                                    $globalVariable->get('typeResolver')->resolve('Contribution'),
                                'args' => [],
                                'resolve' => null,
                                'description' =>
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ...
                                            ->resolve(["proposal_show_url", array(0 => $value)]);
                                    },
                            ...
                            'adminUrl' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["proposal_admin_url", array(0 => $value)]);
                                    },
                            ...
                            'currentVotableStep' => [
                                'type' =>
                                    $globalVariable->get('typeResolver')->resolve('ProposalStep'),
                                'args' => [],
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        $globalVariable
                            ...
                            'project' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable->get('typeResolver')->resolve('Project')
                                    ),
                                'args' => [],
                                'resolve' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\Proposal\\ProposalStatusResolver",
                                                array(0 => $value, 1 => $args),
                                            ]);
                                    },
                                'description' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\Proposal\\ProposalResponsesResolver",
                                                array(
                                                    0 => $value,
                                                    1 =>
                                                        \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser(
                            ...
                            'publicationStatus' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable
                                            ->get('typeResolver')
                                            ->resolve('ProposalPublicationStatus')
                                    ),
                                'args' => [],
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                            ...
                            'reference' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["proposal_reference", array(0 => $value)]);
                                    },
                            ...
                            'evaluation' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["proposal_evaluation", array(0 => $value)]);
                                    },
                            ...
                            'votes' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable
                                            ->get('typeResolver')
                                            ->resolve('ProposalVoteConnection')
                                    ),
                                'args' => [
                                    [
                                        'name' => 'after',
                                    ...
                                    [
                                        ...
                                        'type' => Type::boolean(),
                                        'description' =>
                                            '(ROLE_SUPER_ADMIN only) Select also expired votes.',
                                        'defaultValue' => false,
                                    ],
                                ],
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ...
                                            ->resolve([
                                                ...
                                                array(0 => $value, 1 => $args, 2 => $context),
                                            ]);
                                    },
                                'description' => null,
                                'deprecationReason' => null,
                            ...
                            'postsCount' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["proposal_posts_count", array(0 => $value)]);
                                    },
                                'description' => null,
                                'deprecationReason' => null,
                                'complexity' => null,
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "proposal_viewer_can_see_evaluation",
                                                array(
                                                    0 => $value,
                                                    1 =>
                                                        \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser(
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\Proposal\\ProposalVotableStepsResolver",
                                                array(0 => $value),
                                            ]);
                                    },
                                'description' => null,
                ...
                'interfaces' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            $globalVariable->get('typeResolver')->resolve('Contribution'),
                            $globalVariable->get('typeResolver')->resolve('Reportable'),
                        ];
                    },
                'isTypeOf' => null,
                'resolveField' => null,
