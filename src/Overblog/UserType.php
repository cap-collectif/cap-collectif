                ...
                'fields' =>
                    function () use ($globalVariable) {
                        return [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ...
                                            ->resolve(["user_email", array(0 => $value)]);
                                    },
                                'description' => 'email.',
                                'deprecationReason' => null,
                                'complexity' => null,
                            ...
                            'show_url' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["user_show_url", array(0 => $value)]);
                                    },
                                'description' => null,
                            ...
                            'updatedAt' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["user_updatedAt", array(0 => $value)]);
                                    },
                            ...
                            'lastLogin' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["user_lastLogin", array(0 => $value)]);
                                    },
                            ...
                            'notificationsConfiguration' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable
                                            ->get('typeResolver')
                                            ->resolve('UserNotificationsConfiguration')
                                    ),
                                'args' => [],
                                'resolve' => null,
                            ...
                            'gender' => [
                                'type' =>
                                    $globalVariable->get('typeResolver')->resolve('GenderValue'),
                                'args' => [],
                                'resolve' => null,
                                'description' => null,
                                'deprecationReason' => null,
                            ...
                            'dateOfBirth' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["user_dateOfBirth", array(0 => $value)]);
                                    },
                                'description' => null,
                                'deprecationReason' => null,
                                'complexity' => null,
                            ...
                            'roles' => [
                                'type' =>
                                    Type::listOf(
                                        $globalVariable->get('typeResolver')->resolve('UserRole')
                                    ),
                                'args' => [],
                                'resolve' => null,
                            ...
                            'rolesText' => [
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve(["user_rolesText", array(0 => $value)]);
                                    },
                                'description' =>
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\User\\UserArchiveDeletedResolver",
                                                array(
                                                    0 =>
                                                        \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser(
                                                            $globalVariable
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\User\\UserArchiveReadyResolver",
                                                array(
                                                    0 =>
                                                        \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser(
                                                            $globalVariable
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "Capco\\AppBundle\\GraphQL\\Resolver\\User\\UserArchiveFirstResolver",
                                                array(
                                                    0 =>
                                                        \Overblog\GraphQLBundle\ExpressionLanguage\ExpressionFunction\Security\Helper::getUser(
                                                            $globalVariable
                                ...
                                'resolve' =>
                                    function ($value, $args, $context, ResolveInfo $info) use (
                                        ...
                                        return $globalVariable
                                            ->get('resolverResolver')
                                            ->resolve([
                                                "user_contributionsToDeleteCount",
                                                array(0 => $value),
                                            ]);
                                    },
                                'description' =>
                            ...
                            'medias' => [
                                'type' =>
                                    Type::nonNull(
                                        Type::listOf(
                                            $globalVariable->get('typeResolver')->resolve('Media')
                                        )
                                    ),
                                'args' => [],
                                'resolve' =>
                            ...
                            'contributions' => [
                                'type' =>
                                    Type::nonNull(
                                        $globalVariable
                                            ->get('typeResolver')
                                            ->resolve('ContributionConnection')
                                    ),
                                'args' => [
                                    [
                                        'name' => 'type',
                            ...
                            'isViewer' => [
                                ...
                                'description' => 'Is user given the current viewer ?',
                                'deprecationReason' => null,
                                'complexity' => null,
                                # public and access are custom options managed only by the bundle
                                'public' => null,
