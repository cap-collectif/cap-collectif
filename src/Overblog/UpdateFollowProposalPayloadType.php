 ...
 */
final class UpdateFollowProposalPayloadType extends ObjectType implements GeneratedTypeInterface
{
    public function __construct(
        ...
        $configLoader = function (GlobalVariables $globalVariable) {
            return [
                'name' => 'UpdateFollowProposalPayload',
                'description' => null,
                'fields' =>
                    function () use ($globalVariable) {
                        return [
                            ...
                            'followerEdge' => [
                                'type' =>
                                    $globalVariable->get('typeResolver')->resolve('FollowerEdge'),
                                'args' => [],
                                'resolve' => null,
                                'description' => null,
                                'deprecationReason' => null,
