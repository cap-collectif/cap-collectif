                ...
                'serialize' =>
                    function () use ($globalVariable) {
                        return call_user_func_array(
                            ['Capco\\AppBundle\\GraphQL\\Type\\DateTimeType', 'serialize'],
                            func_get_args()
                        );
                    },
                'parseValue' =>
                    function () use ($globalVariable) {
                        return call_user_func_array(
                            ['Capco\\AppBundle\\GraphQL\\Type\\DateTimeType', 'parseValue'],
                            func_get_args()
                        );
                    },
                'parseLiteral' =>
                    function () use ($globalVariable) {
                        return call_user_func_array(
                            ['Capco\\AppBundle\\GraphQL\\Type\\DateTimeType', 'parseLiteral'],
                            func_get_args()
                        );
                    },
            ];
