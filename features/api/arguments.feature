...
## CRUD
  ...
  Scenario: Anonymous API client wants to update an argument on a version
    When I send a PUT request to "/api/opinions/57/versions/1/arguments/3" with a valid argument update json
    Then the JSON response status code should be 401
  ...
  Scenario: Anonymous API client wants to delete an argument from a version
    When I send a DELETE request to "/api/opinions/57/versions/1/arguments/3"
    Then the JSON response status code should be 401
...
## Report
  ...
  Scenario: Anonymous API client wants to report an argument from a version
    When I send a POST request to "/api/opinions/57/versions/1/arguments/3/reports" with a valid report json
    Then the JSON response status code should be 401
