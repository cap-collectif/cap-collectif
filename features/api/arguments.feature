...
Scenario: Anonymous API client wants to report an argument from an opinion
  When I send a POST request to "/api/opinions/opinion2/arguments/QXJndW1lbnQ6YXJndW1lbnQx/reports" with a valid report json
...
Scenario: Anonymous API client wants to report an argument from a version
  When I send a POST request to "/api/opinions/opinion57/versions/version1/arguments/QXJndW1lbnQ6YXJndW1lbnQyMDQ=/reports" with a valid report json
  Then the JSON response status code should be 403
