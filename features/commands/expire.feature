...
Scenario: Cron wants to expire users
  ...
  And I should see 'email.expire_user.confirm {"%url%":"https:\/\/capco.dev\/account\/email_confirmation\/qsdfghjklm"}' in mail
  ...
  And I should see 'email.expire_user.confirm {"%url%":"https:\/\/capco.dev\/account\/email_confirmation\/oklmoklm"' in mail
