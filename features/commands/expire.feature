...
Scenario: Cron wants to expire users
    ...
    And I should see "Nous sommes au regret de vous annoncer que votre compte a expiré et que vos contenus ont été supprimés, car votre compte n'a pas été vérifié dans un délai de 72 heures." in mail
    And I should see "Confirmer mon adresse électronique et réactiver mon compte" in mail
