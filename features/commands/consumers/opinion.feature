...
Scenario: Moderator should receive a new opinion email if active moderation is enabled
  ...
  Then I open mail with subject 'notification-subject-new-proposal {"{projectName}":"Projet de loi Renseignement","{authorName}":"sfavot"}' from "assistance@cap-collectif.com" to "dev@cap-collectif.com"
...
Scenario: Moderator should receive an updated opinion email if active moderation is enabled
  ...
  Then I open mail with subject 'notification-subject-modified-proposal {"{projectName}":"Projet de loi Renseignement","{authorName}":"sfavot"}' from "assistance@cap-collectif.com" to "dev@cap-collectif.com"
