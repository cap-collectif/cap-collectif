...
Scenario: Moderator should receive a new opinion email if active moderation is enabled
  ...
  And I should see 'notification-content-new-proposal {"{title}":"Article","{body}":"Super opinion de malade","{createdDate}":"01\/03\/2016","{createdTime}":"00:00:00","{authorName}":"sfavot","{authorLink}":"http:\/\/capco.dev\/profile\/sfavot","{opinionLink}":"http:\/\/capco.dev\/consultations\/projet-de-loi-renseignement\/consultation\/elaboration-de-la-loi\/opinions\/titre-ier-la-circulation-des-donnees-et-du-savoir\/chapitre-ier-economie-de-la-donnee\/section-1-ouverture-des-donnees-publiques\/sous-partie-1\/article","{moderateSexualLink}":"http:\/\/capco.dev\/moderate\/6_N2xMowF-VbMJMrnBf2Oz4ZJfTRrQQ2aa_UyPLFC6g\/reason\/reporting.status.sexual","{moderateOffendingLink}":"http:\/\/capco.dev\/moderate\/6_N2xMowF-VbMJMrnBf2Oz4ZJfTRrQQ2aa_UyPLFC6g\/reason\/reporting.status.offending","{moderateInfringementLink}":"http:\/\/capco.dev\/moderate\/6_N2xMowF-VbMJMrnBf2Oz4ZJfTRrQQ2aa_UyPLFC6g\/reason\/infringement-of-rights","{moderateSpamLink}":"http:\/\/capco.dev\/moderate\/6_N2xMowF-VbMJMrnBf2Oz4ZJfTRrQQ2aa_UyPLFC6g\/reason\/reporting.status.spam","{moderateOffTopicLink}":"http:\/\/capco.dev\/moderate\/6_N2xMowF-VbMJMrnBf2Oz4ZJfTRrQQ2aa_UyPLFC6g\/reason\/reporting.status.off_topic","{moderateGuidelineViolationLink}":"http:\/\/capco.dev\/moderate\/6_N2xMowF-VbMJMrnBf2Oz4ZJfTRrQQ2aa_UyPLFC6g\/reason\/moderation-guideline-violation"}' in mail
