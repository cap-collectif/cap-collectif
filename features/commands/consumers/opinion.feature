...
Scenario: Moderator should receive a new opinion email if active moderation is enabled
  ...
  Then I open mail with subject 'notification-subject-new-proposal {"{projectName}":"Article","{authorName}":"sfavot"}' from "assistance@cap-collectif.com" to "dev@cap-collectif.com"
