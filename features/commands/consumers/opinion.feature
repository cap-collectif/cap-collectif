...
Scenario: Author should receive a trashed opinion email
  ...
  And I should see 'notification-content-proposal-in-the-trash {"{trashedReason}":"reporting.status.spam","{title}":"Article visible \u00e0 la corbeille","{body}":"Je suis du spam","{trashedDate}":"02\/03\/2018","{trashedTime}":"00:00:00","{opinionLink}":"https:\/\/capco.dev\/consultations\/projet-de-loi-renseignement\/consultation\/elaboration-de-la-loi\/opinions\/chapitre-ier-economie-de-la-donnee\/section-1-ouverture-des-donnees-publiques\/sous-partie-1\/article-visible-a-la-corbeille"}' in mail
