...
Scenario: Author should receive a trashed opinion email
  ...
  And I should see 'notification.email.external_footer {"{to}":"sfavot@jolicode.com","{sitename}":"Cap-Collectif","{siteUrl}":"http:\/\/capco.dev\/","{businessUrl}":"https:\/\/cap-collectif.com","{business}":"Cap Collectif"}' in mail
