...
Scenario: Moderator should receive a new argument email if active moderation is enabled
  ...
  Then I open mail with subject 'notification-subject-new-argument {"{projectName}":"Article 1","{authorName}":"lbrunet"}' from "assistance@cap-collectif.com" to "dev@cap-collectif.com"
  ...
  And I should see 'notification.email.moderator_footer {"{to}":"dev@cap-collectif.com","{sitename}":"Cap-Collectif","{siteUrl}":"http:\/\/capco.dev\/","{business}":"Cap Collectif","{businessUrl}":"https:\/\/cap-collectif.com\/"}' in mail
...
Scenario: Moderator should receive an updated argument email if active moderation is enabled
  ...
  Then I open mail with subject 'notification-subject-modified-argument {"{projectName}":"Article 1","{authorName}":"lbrunet"}' from "assistance@cap-collectif.com" to "dev@cap-collectif.com"
