...
Scenario: Author should receive a trashed argument email
  ...
  And I should see 'notification.email.external_footer {"{to}":"lbrunet@jolicode.com","{sitename}":"Cap-Collectif","{siteUrl}":"https:\/\/capco.dev\/"}' in mail
