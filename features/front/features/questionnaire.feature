...
# TODO re-write in cypress @TeaAlex https://github.com/cap-collectif/platform/issues/13619
...
#  And I wait "reply.request.create.success" to appear on current page in "body"
