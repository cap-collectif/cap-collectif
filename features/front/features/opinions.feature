...
Scenario: Project's opinions can be sorted randomly
  ...
  And I am on "/projects/projet-avec-beaucoup-dopinions/consultation/consultation-step-in-project-with-many-opinions/types/opinion-type-avec-beaucoup-doptions"
  And I wait "[id='opinion-ordering-selector']" to appear on current page
