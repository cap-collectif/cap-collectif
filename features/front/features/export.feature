...
@database
Scenario: Logged in admin wants to export project related files
  Given I am logged in as admin
  ...
  Then I can download project contributor export with project slug "projet-externe" and projectId "externalProject"
