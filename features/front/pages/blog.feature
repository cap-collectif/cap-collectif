...
Scenario: Anonymous wants to comment a blogpost
  ...
  Then I should see "comment.submit_success" within 5 seconds in the "#global-alert-box" element
...
Scenario: Anonymous wants to comment a blogpost with moderation enabled
  ...
  And I fill in the following:
    ...
    | authorEmail | naruto72@gmail.com  |
  When I press "comment.submit"
  Then I should see "confirm-email-address" within 5 seconds in the "#global-alert-box" element
