...
describe('Public|introspection query', () => {
  ...
  it('doesnt fetch schema if disabled', async () => {
    ...
    await expect(graphql(IntrospectionQuery)).rejects.toThrowErrorMatchingInlineSnapshot(
      `"GraphQL introspection is not allowed, but the query contained __schema or __type: {\\"response\\":{\\"errors\\":[{\\"message\\":\\"GraphQL introspection is not allowed, but the query contained __schema or __type\\",\\"extensions\\":{\\"category\\":\\"graphql\\"},\\"locations\\":[{\\"line\\":3,\\"column\\":5}]}],\\"extensions\\":{\\"debug\\":{\\"executionTime\\":\\"28 ms\\",\\"memoryUsage\\":\\"0.00 MiB\\"}},\\"status\\":200},\\"request\\":{\\"query\\":\\"\\\\n  {\\\\n    __schema {\\\\n      types {\\\\n        name\\\\n      }\\\\n    }\\\\n  }\\\\n\\"}}"`,
    );
  });
});
