  ...
  """
  {
    ...
    "variables": {
      "input": {
        ...
        "stepsIds": ["collectstep1", "selectionQuestionStepVoteClassement"]
      }
    }
  }
  """
...
Scenario: Admin add an already present step to a proposal
  ...
  """
  {
    ...
    "variables": {
      "input": {
        "proposalIds": ["UHJvcG9zYWw6cHJvcG9zYWwx"],
        "stepsIds": ["U2VsZWN0aW9uU3RlcDpzZWxlY3Rpb25zdGVwMQ=="]
      }
    }
  }
  """
  ...
  """
  {
    ...
    "variables": {
      "input": {
        ...
        "stepsIds": ["U2VsZWN0aW9uU3RlcDpzZWxlY3Rpb25zdGVwMg=="]
      }
    }
  }
  """
