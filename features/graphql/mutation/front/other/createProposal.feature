@proposal @create_proposal @other
    ...
    "data": {
      "createProposal": {
        "proposal": {
          ...
          "district":{"id":"RGlzdHJpY3Q6ZGlzdHJpY3Qx","name":"Beauregard"}
        }
      }
    }
  }
...
Scenario: GraphQL client wants to create a proposal out of the zone
  ...
  Then the JSON response should match:
  """
  {"errors":[{"message":"global.address_not_in_zone","@*@": "@*@"}],"data":{"createProposal":null}}
  """
...
Scenario: Logged in API client wants to add a proposal with no category when mandatory
  ...
  Then the JSON response should match:
  """
  {"errors":[{"message":"global.no_category_when_mandatory","@*@": "@*@"}],"data":{"createProposal":null}}
  """
...
Scenario: Logged in API client wants to add a proposal with no address when mandatory
  ...
  Then the JSON response should match:
  """
  {"errors":[{"message":"global.no_address_when_mandatory","@*@": "@*@"}],"data":{"createProposal":null}}
  """
