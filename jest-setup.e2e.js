...
global.graphql = (query, variables, client = 'anonymous') => {
  ...
  switch (client) {
    ...
    case 'internal_user_conseil_regional':
      return authenticatedInternalRequest('conseilregional@test.com', 'monsupermotdepassetropsafe', query, variables)
    ...
    case 'internal_admin_capco':
      return authenticatedInternalRequest('admin@cap-collectif.com', 'admin', query, variables)
    case 'internal_super_admin':
      return authenticatedInternalRequest('lbrunet@cap-collectif.com', 'toto', query, variables)
    case 'internal_sfavot':
      return authenticatedInternalRequest('sfavot@cap-collectif.com', 'toto', query, variables)
    case 'internal_pierre':
    ...
    case 'internal_welcomatic':
      return authenticatedInternalRequest('msantostefano@cap-collectif.com', 'capco', query, variables)
    case 'internal_valerie':
      return authenticatedInternalRequest('valerie.massondelmotte@cap-collectif.com', 'toto', query, variables)
    ...
    case 'internal_agui':
      return authenticatedInternalRequest('julien.aguilar@cap-collectif.com', 'toto', query, variables)
    case 'mediator':
