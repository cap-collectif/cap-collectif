...
final class Version20191114145410 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function postUp(Schema $schema): void
    {
        ...
        $this->connection->exec('ALTER TABLE theme DROP title, DROP slug, DROP teaser, DROP body, DROP meta_description');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE theme ADD title VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, ADD slug VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, ADD teaser VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, ADD body LONGTEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, ADD meta_description VARCHAR(160) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`');
