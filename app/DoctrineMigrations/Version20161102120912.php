...
class Version20161102120912 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE proposal DROP service_pilote, DROP domaniality, DROP compatibility, DROP environmental_impact, DROP dimension, DROP functioning_impact, DROP evaluation, DROP delay, DROP proposed_answer');
    }
}
