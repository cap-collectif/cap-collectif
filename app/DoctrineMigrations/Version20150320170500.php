...
class Version20150320170500 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE idea_vote ADD message LONGTEXT DEFAULT NULL, ADD confirmed TINYINT(1) NOT NULL, ADD username VARCHAR(255) DEFAULT NULL, ADD email VARCHAR(255) DEFAULT NULL, ADD ip_address VARCHAR(255) DEFAULT NULL, ADD private TINYINT(1) NOT NULL');
        ...
        $this->addSql('ALTER TABLE idea_vote ADD CONSTRAINT FK_995930CF94D2D6E1 FOREIGN KEY (Idea_id) REFERENCES idea (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE idea_vote DROP message, DROP confirmed, DROP username, DROP email, DROP ip_address, DROP private');
