...
class Version20151030144445 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE proposal ADD district_id INT DEFAULT NULL, ADD status_id INT NOT NULL, ADD votes_count INT NOT NULL, DROP vote_count, DROP vote_count_ok');
        ...
        $this->addSql('ALTER TABLE status ADD step_id INT NOT NULL, ADD position INT NOT NULL, ADD color VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE proposal ADD vote_count INT NOT NULL, ADD vote_count_ok INT NOT NULL, DROP district_id, DROP status_id, DROP votes_count');
