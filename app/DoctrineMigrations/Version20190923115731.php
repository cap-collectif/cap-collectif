...
final class Version20190923115731 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE IF EXISTS project_district');
        $this->addSql(
            'CREATE TABLE project_district (project_id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\', projectdistrict_id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\', INDEX IDX_C8FDF5CCB622938 (projectdistrict_id), INDEX IDX_C8FDF5C166D1F9C (project_id), PRIMARY KEY(project_id, projectdistrict_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' '
        );
        $this->addSql(
