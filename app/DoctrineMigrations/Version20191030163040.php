...
final class Version20191030163040 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE event ADD review_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', ADD deleted_at DATETIME DEFAULT NULL'
        );
        $this->addSql(
            'ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA73E2E969B FOREIGN KEY (review_id) REFERENCES event_review (id) ON DELETE SET NULL'
        );
