 ...
 */
class Version20180423140209 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fos_user DROP idea_comments_count, DROP idea_votes_count, DROP ideas_count');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE idea ADD CONSTRAINT FK_A8BCA4559027487 FOREIGN KEY (theme_id) REFERENCES theme (id)');
        ...
        $this->addSql('ALTER TABLE fos_user ADD idea_comments_count INT NOT NULL, ADD idea_votes_count INT NOT NULL, ADD ideas_count INT NOT NULL');
