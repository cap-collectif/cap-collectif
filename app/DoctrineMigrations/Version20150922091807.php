...
class Version20150922091807 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE step ADD nb_opinions_to_display INT DEFAULT NULL, ADD nb_versions_to_display INT DEFAULT NULL');
        $this->addSql('ALTER TABLE consultation ADD opinions_ranking_threshold INT DEFAULT NULL, ADD versions_ranking_threshold INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE consultation DROP opinions_ranking_threshold, DROP versions_ranking_threshold');
