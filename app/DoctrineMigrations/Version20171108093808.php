...
class Version20171108093808 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->connection->update('site_parameter', ['position' => 3], ['keyname' => 'global.site.embed_js']);

        // Add consent external communication to the table user
        $this->addSql('ALTER TABLE fos_user ADD consent_external_communication TINYINT(1) NOT NULL');
    }

    public function down(Schema $schema)
    {
        $this->connection->delete('site_parameter', ['keyname' => 'global.site.organization_name']);
        $this->connection->update('site_parameter', ['position' => 2], ['keyname' => 'global.site.embed_js']);
