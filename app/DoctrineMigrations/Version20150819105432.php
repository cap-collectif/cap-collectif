...
class Version20150819105432 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE opinion_appendices ADD CONSTRAINT FK_CE7C748A8DAE1A1E FOREIGN KEY (opinion_type_part_id) REFERENCES opinion_type_appendices_type (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE opinion_appendices ADD CONSTRAINT FK_CE7C748A51885A6A FOREIGN KEY (opinion_id) REFERENCES opinion (id) ON DELETE CASCADE');
