...
class Version20150415150859 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE menu_item CHANGE isfullymodifiable is_fully_modifiable TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE menu_item CHANGE is_fully_modifiable isFullyModifiable TINYINT(1) NOT NULL');
    }
}
