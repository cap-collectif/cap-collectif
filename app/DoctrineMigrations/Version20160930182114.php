...
class Version20160930182114 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE responses_medias (response_id INT NOT NULL, media_id INT NOT NULL, INDEX IDX_EE827965FBF32840 (response_id), INDEX IDX_EE827965EA9FDD75 (media_id), PRIMARY KEY(response_id, media_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE responses_medias ADD CONSTRAINT FK_EE827965FBF32840 FOREIGN KEY (response_id) REFERENCES response (id)');
        $this->addSql('ALTER TABLE responses_medias ADD CONSTRAINT FK_EE827965EA9FDD75 FOREIGN KEY (media_id) REFERENCES media__media (id)');
