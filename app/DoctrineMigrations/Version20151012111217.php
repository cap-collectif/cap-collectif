...
class Version20151012111217 extends AbstractMigration
{
    ...
    public function preUp(Schema $schema)
    {
        ...
        $this->consultation_abstractsteps = $this->connection->fetchAll('SELECT * FROM consultation_abstractstep');
        $this->consultation_events        = $this->connection->fetchAll('SELECT * FROM consultation_event');
        ...
        $this->theme_consultations        = $this->connection->fetchAll('SELECT * FROM theme_consultation');
    }
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE consultation_step_type (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_event (event_id INT NOT NULL, project_id INT NOT NULL, INDEX IDX_28FB033971F7E88B (event_id), INDEX IDX_28FB0339166D1F9C (project_id), PRIMARY KEY(event_id, project_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_post (post_id INT NOT NULL, project_id INT NOT NULL, INDEX IDX_631BA4954B89032C (post_id), INDEX IDX_631BA495166D1F9C (project_id), PRIMARY KEY(post_id, project_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, cover_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, is_enabled TINYINT(1) NOT NULL, exportable TINYINT(1) NOT NULL, published_at DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, video VARCHAR(255) DEFAULT NULL, participants_count INT NOT NULL, contributions_count INT NOT NULL, votes_count INT NOT NULL, opinions_ranking_threshold INT DEFAULT NULL, versions_ranking_threshold INT DEFAULT NULL, include_author_in_ranking TINYINT(1) NOT NULL, opinion_term INT NOT NULL, INDEX IDX_2FB3D0EEF675F31B (author_id), INDEX IDX_2FB3D0EE922726E9 (cover_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE theme_project (project_id INT NOT NULL, theme_id INT NOT NULL, INDEX IDX_76D0D5CD166D1F9C (project_id), INDEX IDX_76D0D5CD59027487 (theme_id), PRIMARY KEY(project_id, theme_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_abstractstep (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, step_id INT NOT NULL, position INT NOT NULL, INDEX IDX_79774AB7166D1F9C (project_id), UNIQUE INDEX UNIQ_79774AB773B21E9C (step_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE proposal (id INT AUTO_INCREMENT NOT NULL, theme_id INT DEFAULT NULL, step_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, body LONGTEXT NOT NULL, rating INT NULL, annotation LONGTEXT NULL, vote_count INT NOT NULL, comments_count INT NOT NULL, is_commentable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, vote_count_nok INT NOT NULL, vote_count_ok INT NOT NULL, vote_count_mitige INT NOT NULL, enabled TINYINT(1) NOT NULL, trashed TINYINT(1) NOT NULL, trashed_at DATETIME DEFAULT NULL, trashed_reason LONGTEXT DEFAULT NULL, INDEX IDX_BFE5947259027487 (theme_id), INDEX IDX_BFE5947273B21E9C (step_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE project_post ADD CONSTRAINT FK_631BA4954B89032C FOREIGN KEY (post_id) REFERENCES blog_post (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE project_post ADD CONSTRAINT FK_631BA495166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EE922726E9 FOREIGN KEY (cover_id) REFERENCES media__media (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE theme_project ADD CONSTRAINT FK_76D0D5CD166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE theme_project ADD CONSTRAINT FK_76D0D5CD59027487 FOREIGN KEY (theme_id) REFERENCES theme (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE project_abstractstep ADD CONSTRAINT FK_79774AB7166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE project_abstractstep ADD CONSTRAINT FK_79774AB773B21E9C FOREIGN KEY (step_id) REFERENCES step (id) ON DELETE CASCADE');
    ...
    public function preDown(Schema $schema)
    {
        ...
        $this->consultation_abstractsteps = $this->connection->fetchAll('SELECT * FROM project_abstractstep');
        ...
        $this->consultation_types         = $this->connection->fetchAll('SELECT * FROM consultation_step_type');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, cover_id INT DEFAULT NULL, author_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, is_enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, video VARCHAR(255) DEFAULT NULL, published_at DATETIME NOT NULL, participants_count INT NOT NULL, contributions_count INT NOT NULL, exportable TINYINT(1) NOT NULL, votes_count INT NOT NULL, opinions_ranking_threshold INT DEFAULT NULL, versions_ranking_threshold INT DEFAULT NULL, include_author_in_ranking TINYINT(1) NOT NULL, opinion_term INT NOT NULL, INDEX IDX_964685A6F675F31B (author_id), INDEX IDX_964685A6922726E9 (cover_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_abstractstep (id INT AUTO_INCREMENT NOT NULL, consultation_id INT NOT NULL, step_id INT NOT NULL, position INT NOT NULL, UNIQUE INDEX UNIQ_B0564EB073B21E9C (step_id), INDEX IDX_B0564EB062FF6CDF (consultation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_event (event_id INT NOT NULL, consultation_id INT NOT NULL, INDEX IDX_4034E88971F7E88B (event_id), INDEX IDX_4034E88962FF6CDF (consultation_id), PRIMARY KEY(event_id, consultation_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_post (post_id INT NOT NULL, consultation_id INT NOT NULL, INDEX IDX_7143EC474B89032C (post_id), INDEX IDX_7143EC4762FF6CDF (consultation_id), PRIMARY KEY(post_id, consultation_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_type (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE theme_consultation (consultation_id INT NOT NULL, theme_id INT NOT NULL, INDEX IDX_611B32459027487 (theme_id), INDEX IDX_611B32462FF6CDF (consultation_id), PRIMARY KEY(consultation_id, theme_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A6922726E9 FOREIGN KEY (cover_id) REFERENCES media__media (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A6F675F31B FOREIGN KEY (author_id) REFERENCES fos_user (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE consultation_abstractstep ADD CONSTRAINT FK_1064E18E62FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_abstractstep ADD CONSTRAINT FK_1064E18E73B21E9C FOREIGN KEY (step_id) REFERENCES step (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_event ADD CONSTRAINT FK_4034E88962FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_event ADD CONSTRAINT FK_4034E88971F7E88B FOREIGN KEY (event_id) REFERENCES event (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_post ADD CONSTRAINT FK_7143EC474B89032C FOREIGN KEY (post_id) REFERENCES blog_post (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_post ADD CONSTRAINT FK_7143EC4762FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE theme_consultation ADD CONSTRAINT FK_611B32459027487 FOREIGN KEY (theme_id) REFERENCES theme (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE theme_consultation ADD CONSTRAINT FK_611B32462FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
    ...
    public function postDown(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE highlighted_content ADD CONSTRAINT FK_5143CD2862FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE opinion_type ADD CONSTRAINT FK_F11F2BF0804F7D71 FOREIGN KEY (consultation_type_id) REFERENCES consultation_type (id) ON DELETE CASCADE');
