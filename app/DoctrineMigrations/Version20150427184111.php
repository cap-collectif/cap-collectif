...
class Version20150427184111 extends AbstractMigration
{
    ...
    public function preUp(Schema $schema)
    {
        ...
        foreach ($this->steps as &$step) {
            switch ($step['type']) {
                case 0: $step['step_type'] = 'other'; break;
                case 1: $step['step_type'] = 'consultation'; break;
                case 2: $step['step_type'] = 'presentation'; break;
                default: die('unknown step type for step : '. $step['id']); break;
            }
        }
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE consultationstep_opiniontypes (consultationstep_id INT NOT NULL, opiniontype_id INT NOT NULL, INDEX IDX_4D642691562C6E32 (consultationstep_id), INDEX IDX_4D64269135365590 (opiniontype_id), PRIMARY KEY(consultationstep_id, opiniontype_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_abstractstep (id INT AUTO_INCREMENT NOT NULL, consultation_id INT NOT NULL, step_id INT NOT NULL, position INT NOT NULL, INDEX IDX_1064E18E62FF6CDF (consultation_id), UNIQUE INDEX UNIQ_1064E18E73B21E9C (step_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultationtype_opiniontypes (consultationtype_id INT NOT NULL, opiniontype_id INT NOT NULL, INDEX IDX_93E37484E0D2FC3D (consultationtype_id), INDEX IDX_93E3748435365590 (opiniontype_id), PRIMARY KEY(consultationtype_id, opiniontype_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE step ADD step_type VARCHAR(255) NOT NULL, ADD trashed_opinion_count INT DEFAULT NULL, ADD argument_count INT DEFAULT NULL, ADD trashed_argument_count INT DEFAULT NULL, ADD sources_count INT DEFAULT NULL, ADD trashed_sources_count INT DEFAULT NULL, DROP position, DROP type, CHANGE consultation_id opinion_count INT DEFAULT NULL');
        $this->addSql('ALTER TABLE consultation DROP opinion_count, DROP trashed_opinion_count, DROP argument_count, DROP trashed_argument_count, DROP sources_count, DROP trashed_sources_count');
    }
    ...
    public function postUp(Schema $schema)
    {
        foreach ($this->steps as $step) {
            ...
            $this->connection->update('step', ['step_type' => $step['step_type']], ['id' => $step['id']]);
        }
    ...
    public function preDown(Schema $schema)
    {
        ...
        foreach ($this->steps as &$step) {
            switch ($step['step_type']) {
                case 'other': $step['type'] = 0; break;
                case 'consultation': $step['type'] = 1; break;
                case 'presentation': $step['type'] = 2; break;
                default: die('unknown step type for step : '. $step['id']); break;
            }
        }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE consultation_type_types (consultationtype_id INT NOT NULL, opiniontype_id INT NOT NULL, INDEX IDX_69F48B0AE0D2FC3D (consultationtype_id), INDEX IDX_69F48B0A35365590 (opiniontype_id), PRIMARY KEY(consultationtype_id, opiniontype_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation_types (consultation_id INT NOT NULL, opiniontype_id INT NOT NULL, INDEX IDX_22AA6B1E62FF6CDF (consultation_id), INDEX IDX_22AA6B1E35365590 (opiniontype_id), PRIMARY KEY(consultation_id, opiniontype_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE consultation_type_types ADD CONSTRAINT FK_69F48B0AE0D2FC3D FOREIGN KEY (consultationtype_id) REFERENCES consultation_type (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_types ADD CONSTRAINT FK_22AA6B1E35365590 FOREIGN KEY (opiniontype_id) REFERENCES opinion_type (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE consultation_types ADD CONSTRAINT FK_22AA6B1E62FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE step ADD CONSTRAINT FK_43B9FE3C62FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id)');
