 ...
 */
final class Version20190417154237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consultation (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', step_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_964685A673B21E9C (step_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A673B21E9C FOREIGN KEY (step_id) REFERENCES step (id) ON DELETE SET NULL');
        $this->addSql('DROP TABLE consultation_step_type');
        $this->addSql('DROP INDEX IDX_F11F2BF09637EA18 ON opinion_type');
        $this->addSql('ALTER TABLE opinion_type CHANGE consultation_step_type_id consultation_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE opinion_type ADD CONSTRAINT FK_F11F2BF062FF6CDF FOREIGN KEY (consultation_id) REFERENCES consultation (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE opinion_type CHANGE consultation_id consultation_step_type_id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
