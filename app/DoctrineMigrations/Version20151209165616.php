...
class Version20151209165616 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE opinion_relation (opinion_source INT NOT NULL, opinion_target INT NOT NULL, INDEX IDX_986BCBE056C341F3 (opinion_source), INDEX IDX_986BCBE04F26117C (opinion_target), PRIMARY KEY(opinion_source, opinion_target)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE opinion_relation ADD CONSTRAINT FK_986BCBE056C341F3 FOREIGN KEY (opinion_source) REFERENCES opinion (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE opinion_relation ADD CONSTRAINT FK_986BCBE04F26117C FOREIGN KEY (opinion_target) REFERENCES opinion (id) ON DELETE CASCADE');
