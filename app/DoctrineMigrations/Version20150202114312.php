...
class Version20150202114312 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, isEnabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, cover_id INT DEFAULT NULL, image_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, teaser LONGTEXT NOT NULL, body LONGTEXT NOT NULL, is_enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, opinion_count INT NOT NULL, trashed_opinion_count INT NOT NULL, argument_count INT NOT NULL, trashed_argument_count INT NOT NULL, video VARCHAR(255) DEFAULT NULL, INDEX IDX_964685A6F675F31B (author_id), INDEX IDX_964685A6922726E9 (cover_id), INDEX IDX_964685A63DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE footer_social_network (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, style VARCHAR(20) NOT NULL, position INT NOT NULL, is_enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE idea (id INT AUTO_INCREMENT NOT NULL, theme_id INT DEFAULT NULL, author_id INT DEFAULT NULL, media_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, is_enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, vote_count INT NOT NULL, is_trashed TINYINT(1) NOT NULL, trashed_at DATETIME DEFAULT NULL, trashed_reason LONGTEXT DEFAULT NULL, INDEX IDX_A8BCA4559027487 (theme_id), INDEX IDX_A8BCA45F675F31B (author_id), UNIQUE INDEX UNIQ_A8BCA45EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE idea_vote (id INT AUTO_INCREMENT NOT NULL, voter_id INT DEFAULT NULL, created_at DATETIME NOT NULL, Idea_id INT DEFAULT NULL, INDEX IDX_995930CF94D2D6E1 (Idea_id), INDEX IDX_995930CFEBB4B8AD (voter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu_item (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, menu_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, link VARCHAR(255) DEFAULT NULL, is_enabled TINYINT(1) NOT NULL, is_deletable TINYINT(1) NOT NULL, isFullyModifiable TINYINT(1) NOT NULL, position INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, Page_id INT DEFAULT NULL, INDEX IDX_D754D550C3FB5A78 (Page_id), INDEX IDX_D754D550727ACA70 (parent_id), INDEX IDX_D754D550CCD7E912 (menu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE newsletter_subscription (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_A82B55ADE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE opinion (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, opinion_type_id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, is_enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_trashed TINYINT(1) NOT NULL, trashed_at DATETIME DEFAULT NULL, trashed_reason LONGTEXT DEFAULT NULL, vote_count_nok INT NOT NULL, vote_count_ok INT NOT NULL, vote_count_mitige INT NOT NULL, sources_count INT NOT NULL, arguments_count INT NOT NULL, Consultation_id INT DEFAULT NULL, INDEX IDX_AB02B027F675F31B (author_id), INDEX IDX_AB02B02728FD468D (opinion_type_id), INDEX IDX_AB02B027EA3A5241 (Consultation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE opinion_type (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, short_name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, position INT NOT NULL, vote_widget_type INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, color VARCHAR(50) NOT NULL, is_enabled TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_140AB620EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE blog_post (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, abstract LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, is_published TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, published_at DATETIME DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_BA5AE01DEA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE blog_post_authors (post_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_E93872E54B89032C (post_id), INDEX IDX_E93872E5A76ED395 (user_id), PRIMARY KEY(post_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reporting (id INT AUTO_INCREMENT NOT NULL, reporter_id INT DEFAULT NULL, opinion_id INT DEFAULT NULL, source_id INT DEFAULT NULL, argument_id INT DEFAULT NULL, idea_id INT DEFAULT NULL, status INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, body LONGTEXT NOT NULL, is_archived TINYINT(1) NOT NULL, INDEX IDX_BD7CFA9FE1CFE6F5 (reporter_id), INDEX IDX_BD7CFA9F51885A6A (opinion_id), INDEX IDX_BD7CFA9F953C1C61 (source_id), INDEX IDX_BD7CFA9F3DD48F21 (argument_id), INDEX IDX_BD7CFA9F5B6FEF7D (idea_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_color (id INT AUTO_INCREMENT NOT NULL, keyname VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, is_enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, value VARCHAR(25) DEFAULT NULL, position INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_image (id INT AUTO_INCREMENT NOT NULL, keyname VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_enabled TINYINT(1) NOT NULL, position INT NOT NULL, Media_id INT DEFAULT NULL, INDEX IDX_167D45A13E9BF23 (Media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_parameter (id INT AUTO_INCREMENT NOT NULL, keyname VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, value LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_enabled TINYINT(1) NOT NULL, position INT NOT NULL, type INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE social_network (id INT AUTO_INCREMENT NOT NULL, media_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, position INT NOT NULL, is_enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_EFFF5221EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE source (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, opinion_id INT NOT NULL, category_id INT NOT NULL, media_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, link TINYTEXT DEFAULT NULL, body LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_enabled TINYINT(1) NOT NULL, type INT NOT NULL, vote_count_source INT NOT NULL, is_trashed TINYINT(1) NOT NULL, trashed_at DATETIME DEFAULT NULL, trashed_reason LONGTEXT DEFAULT NULL, INDEX IDX_5F8A7F73F675F31B (author_id), INDEX IDX_5F8A7F7351885A6A (opinion_id), INDEX IDX_5F8A7F7312469DE2 (category_id), UNIQUE INDEX UNIQ_5F8A7F73EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE step (id INT AUTO_INCREMENT NOT NULL, consultation_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, position INT NOT NULL, type INT NOT NULL, is_enabled TINYINT(1) NOT NULL, body LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_43B9FE3C62FF6CDF (consultation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE theme (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, media_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, teaser VARCHAR(255) NOT NULL, is_enabled TINYINT(1) NOT NULL, position INT NOT NULL, status INT NOT NULL, body LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_9775E708F675F31B (author_id), UNIQUE INDEX UNIQ_9775E708EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE theme_consultation (theme_id INT NOT NULL, consultation_id INT NOT NULL, INDEX IDX_611B32459027487 (theme_id), INDEX IDX_611B32462FF6CDF (consultation_id), PRIMARY KEY(theme_id, consultation_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE menu_item ADD CONSTRAINT FK_D754D550C3FB5A78 FOREIGN KEY (Page_id) REFERENCES page (id)');
