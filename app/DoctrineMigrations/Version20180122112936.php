...
class Version20180122112936 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE proposal_form ADD CONSTRAINT FK_72E9E83473B21E9C FOREIGN KEY (step_id) REFERENCES step (id) ON DELETE SET NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        if (!$this->sm->tablesExist(['fos_user_user_group', 'fos_user_group'])) {
            ...
            $this->addSql('CREATE TABLE fos_user_user_group (user_id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\', group_id INT NOT NULL, INDEX IDX_B3C77447FE54D947 (group_id), INDEX IDX_B3C77447A76ED395 (user_id), PRIMARY KEY(user_id, group_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE proposal_form DROP FOREIGN KEY FK_72E9E83473B21E9C');
        $this->addSql('ALTER TABLE proposal_form ADD CONSTRAINT FK_72E9E83473B21E9C FOREIGN KEY (step_id) REFERENCES step (id) ON DELETE CASCADE');
    }
}
