...
class Version20151208152158 extends AbstractMigration
{
    public function preUp(Schema $schema)
    {
        ...
        foreach ($opinionTypes as $ot) {
            $this->connection->update('opinion_type',
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE opinion_type CHANGE consultation_step_type_id consultation_step_type_id INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE opinion_type CHANGE consultation_step_type_id consultation_step_type_id INT DEFAULT NULL');
    }
