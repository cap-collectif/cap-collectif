...
class Version20150413162136 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fos_user ADD comments_count INT NOT NULL, ADD votes_count INT NOT NULL, DROP idea_comments_count, DROP post_comments_count, DROP event_comments_count, DROP idea_votes_count, DROP comment_votes_count, DROP opinion_votes_count, DROP source_votes_count, DROP argument_votes_count');
    }
}
