...
class Version20180530121506 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_requirement (user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', requirement_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', value TINYINT(1) NOT NULL, INDEX IDX_72249CC5A76ED395 (user_id), INDEX IDX_72249CC57B576F77 (requirement_id), PRIMARY KEY(user_id, requirement_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_requirement ADD CONSTRAINT FK_72249CC5A76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE requirement ADD CONSTRAINT FK_DB3F555073B21E9C FOREIGN KEY (step_id) REFERENCES step (id)');
