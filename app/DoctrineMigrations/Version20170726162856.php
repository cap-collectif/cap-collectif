...
class Version20170726162856 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE consultation_step_type ADD step_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE consultation_step_type ADD CONSTRAINT FK_64BADC9F73B21E9C FOREIGN KEY (step_id) REFERENCES step (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_64BADC9F73B21E9C ON consultation_step_type (step_id)');
    }
    ...
    public function postUp(Schema $schema)
    {
        ...
        foreach ($steps as $step) {
          if ($step['consultation_step_type_id'] != null) {
            $this->connection->update('consultation_step_type', ['step_id' => $step['id']], ['id' => $step['consultation_step_type_id']]);
          }
        }
    }
