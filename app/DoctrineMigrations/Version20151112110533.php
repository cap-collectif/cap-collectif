...
class Version20151112110533 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE opinion_version ADD CONSTRAINT FK_52AD19DD51885A6A FOREIGN KEY (opinion_id) REFERENCES opinion (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE opinion ADD CONSTRAINT FK_AB02B027AA334807 FOREIGN KEY (answer_id) REFERENCES answer (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE opinion_version ADD CONSTRAINT FK_52AD19DDAA334807 FOREIGN KEY (answer_id) REFERENCES answer (id) ON DELETE SET NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE proposal DROP FOREIGN KEY FK_BFE59472AA334807');
        $this->addSql('ALTER TABLE proposal ADD CONSTRAINT FK_BFE59472AA334807 FOREIGN KEY (answer_id) REFERENCES answer (id)');
        $this->addSql('ALTER TABLE opinion_version DROP FOREIGN KEY FK_52AD19DDAA334807');
        $this->addSql('ALTER TABLE opinion_version ADD CONSTRAINT FK_52AD19DDAA334807 FOREIGN KEY (answer_id) REFERENCES answer (id)');
    }
}
