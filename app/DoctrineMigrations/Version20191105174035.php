...
final class Version20191105174035 extends AbstractMigration
{
    ...
    public function postUp(Schema $schema) : void
    {
        ...
        $this->connection->exec('ALTER TABLE page DROP title, DROP slug, DROP body, DROP meta_description');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page ADD title VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD slug VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD body LONGTEXT NOT NULL COLLATE utf8_unicode_ci, ADD meta_description VARCHAR(160) DEFAULT NULL COLLATE utf8_unicode_ci, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
}
