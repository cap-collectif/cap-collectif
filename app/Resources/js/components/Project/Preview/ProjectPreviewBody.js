...
const ProjectPreviewBody = React.createClass({
  ...
  render() {
    ...
    if (this.shouldRenderProgressBar()) {
      progress = (
        <div>
          <p style={{ marginBottom: 10, height: 16 }} className="small">Etat d'avancement</p>
    ...
    return (
      <div className="box project__preview__body">
        <div style={{ height: 130 }}>
            ...
            <OverlayTrigger placement="top" overlay={tooltip}>
              <a href={link}>
                <div style={{ width: '98%' }}>
                  ...
                  {
                    externalLink &&
                    <svg style={{ marginLeft: 5, display: 'inline-block', height: 16, width: 16 }} version="1.1"
                         id="Calque_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
          ...
          <Truncate lines={1} className="project__preview__author excerpt small">{ project.author.displayName }</Truncate>
        </div>
        {progress}
      </div>
    );
