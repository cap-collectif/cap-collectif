...
describe('<ProposalPreviewFooter />', () => {
  ...
  it('should render a footer with comment counter', () => {
    ...
    expect(commentsCounter.find('.proposal__counter__value').text()).toEqual(`${proposal.comments_count}`);
  });
  ...
  it('should render a footer with comment and votes counters', () => {
    ...
    expect(votesCounter.find('.proposal__counter__value').text()).toEqual(`${proposal.votesCountByStepId[1]}`);
  });
});
