...
export const formName = 'requirements-form-consultation';
...
type RequirementsFormConsultation_step = {|
  +requirements: {|
    +edges: ?$ReadOnlyArray<?{|
      +node: Requirement,
    |}>,
...
type Props = {
  ...FormProps,
  step: RequirementsFormConsultation_step,
};
...
export class RequirementsFormConsultation extends React.Component<Props> {
  render() {
...
export default createFragmentContainer(container, {
  step: graphql`
    fragment RequirementsFormConsultation_step on Consultation {
      requirements {
        edges {
          node {
            __typename
