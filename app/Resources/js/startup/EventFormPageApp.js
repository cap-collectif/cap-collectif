...
import type { EventFormPageAppQueryResponse, EventFormPageAppQueryVariables } from "~relay/EventFormPageAppQuery.graphql";
    ...
    <IntlProvider>
      <QueryRenderer
        ...
        query={graphql`
          ...
          `}
        variables={({ eventId: data.eventId, withEventOnly: false }: EventFormPageAppQueryVariables)}
