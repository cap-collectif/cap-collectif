...
storiesOf('Cap Collectif|Accordion', module).add('3 inputs', () => {
  const inputs = [
    {
      key: '0',
  ...
  return (
    <div style={{ maxWidth: 1000, margin: 'auto' }}>
      <Accordion
        ...
        openedColor={text('openedColor', '#CB3F71')}
        closedColor={text('closedColor', '#E8A8BF')}
        titleColor={text('titleColor', '#FFF')}
      />
    </div>
  );
});
