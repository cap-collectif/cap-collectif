...
const OpinionSourceList = ({ section, opinionSources }) => (
  <div>
    <Panel>
      <Panel.Heading>
        <Row>
...
storiesOf('OpinionSourceList', module)
  ...
  .add('default case', () => {
    ...
    return <OpinionSourceList section={section} opinionSources={opinionSourcesMock} />;
  })
  .add('empty', () => {
    const section = {
      addSourceEnable: boolean('Add source enabled', true, 'Section'),
    ...
    return <OpinionSourceList section={section} opinionSources={[]} />;
  })
  .add('with single opinion source', () => {
    ...
    return <OpinionSourceList section={section} opinionSources={[opinionSourcesMock[0]]} />;
  });
