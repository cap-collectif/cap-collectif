...
if (!window['google']['loader']) {
  ...
  (function() {
    ...
    function J(a, b) {
      for (var c = a.split(/\./), e = d, f = 0; f < c[B] - 1; f++)
        e[c[f]] || (e[c[f]] = {}), (e = e[c[f]]);
      e[c[c[B] - 1]] = b;
    }
    function K(a, b, c) {
    ...
    l(google, function(a, b, c) {
      function e(a) {
        ...
        'undefined' != typeof b[1] &&
          ((f = b[0]), (c.packages = c.packages || []), c.packages[z](b[1]));
      }
      var f = a;
      c = c || {};
      if (
    ...
    google[A].W = function() {
      ...
      'complete' == a.readyState &&
        ((a.onreadystatechange = null), a.parentNode.removeChild(a), R());
    };
    L('google.loader.domReady', google[A].W);
    var ca = { loaded: !0, complete: !0 };
    function aa() {
    ...
    google[A].aa = function(a) {
      for (var b in a)
        'string' == typeof b && b && ':' == b[y](0) && !N[b] && (N[b] = new T(b[x](1), a[b]));
    };
    ...
    U[q].H = function(a) {
      ...
      if (b)
        if ('string' == typeof b) c = [a.packages];
          ...
          for (c = [], a = 0; a < b[B]; a++)
            'string' == typeof b[a] && c[z](b[a][w](/^\s*|\s*$/, '')[C]());
      c || (c = ['default']);
      b = [];
      ...
      if (c[B]) {
        ...
        if (
          ...
          for (var S in c.properties)
            S && ':' == S[y](0) && (google[this.b][S[x](1)] = c.properties[S]);
    ...
    l(V[q], function(a, b) {
      ...
      c
        ? (this.m[z](b.callback), (b.callback = `google.loader.callbacks.${this[n]}`))
        : (this.j = !0);
    ...
    var ea = !1,
      ...
      da = function(a, b, c) {
        c
          ? ia([a], [b])
          : (ha(), Y[z](`r${Y[B]}=${g(a + (b ? `|${b}` : ''))}`), d[v](ga, 5 < Y[B] ? 0 : 15e3));
      },
      ga = function() {
        if (Y[B]) {
          var a = google[A][r];
