declare module "react-bootstrap" {
  ...
  declare export type BsSize = 'lg' | 'large' | 'sm' | 'small' | 'xsmall' | 'xs' | 'medium';
  declare export type BsStyle = 'success' | 'warning' | 'danger' | 'info' | 'link' | 'primary' | 'default';
  declare export type ValidationState = 'success' | 'warning' | 'error' | null;
  ...
  declare export class ToggleButtonGroup  extends React$Component<{children?: any}> {}
  ...
  declare export class Tab extends React$Component<{
    ...
    static Pane: Class<TabPane>;
    static Container: Class<TabContainer>;
    static Content: Class<TabContent>;
  }
  ...
  declare export class Accordion extends  React$Component<{}> {}
