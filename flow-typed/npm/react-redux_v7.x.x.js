...
/**
The order of type arguments for connect<any, any,_,_,_,_>() is as follows:
...
declare module "react-redux" {
  // ------------------------------------------------------------
  // Typings for connect<any, any,_,_,_,_>()
  // ------------------------------------------------------------
  ...
  // Just make the OP parameter for `connect<any, any,_,_,_,_>()` an exact object.
  ...
  declare export type ReactReduxContainer<TComponent> = React$ComponentType<TComponent>;
