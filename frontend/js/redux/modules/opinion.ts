...
type CloseOpinionEditModalAction = {
...
export type State = {
  readonly showOpinionCreateModal: Uuid | null | undefined
  readonly showOpinionEditModal: Uuid | null | undefined
  readonly showArgumentEditModal: Uuid | null | undefined
  readonly showOpinionVersionEditModal: boolean
  readonly isCreatingOpinionVersion: boolean
  readonly showOpinionVersionCreateModal: boolean
  readonly showSourceCreateModal: boolean
  readonly showSourceEditModal: Uuid | null | undefined
}
