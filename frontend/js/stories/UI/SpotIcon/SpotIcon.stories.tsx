...
export default {
  ...
  argTypes: {
    name: {
      control: {
        type: 'select',
        options: Object.values(SPOT_ICON_NAME).sort() as any as string[],
      },
    },
    size: {
      control: {
        type: 'select',
        options: Object.keys(SPOT_ICON_SIZE).reverse() as any as string[],
      },
    },
  },
}
const listIconName = Object.values(SPOT_ICON_NAME).sort() as any as string[]
const listIconSize = Object.keys(SPOT_ICON_SIZE).reverse() as any as string[]
