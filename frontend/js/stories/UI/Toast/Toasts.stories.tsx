...
const Template = (args: any) => (
  <Flex direction={['column', 'row']} gridGap={2} wrap="wrap">
    <Button
      ...
      variantSize="medium"
      onClick={() => {
        toast({ ...args, variant: 'success', content: 'Je suis un toast de type success' })
      }}
    >
      Notify success
    </Button>
    <Button
      ...
      variantSize="medium"
      onClick={() => {
        toast({ ...args, variant: 'info', content: 'Je suis un toast de type info' })
      }}
    >
      Notify info
    </Button>
    <Button
      ...
      variantSize="medium"
      onClick={() => {
        toast({ ...args, variant: 'warning', content: 'Je suis un toast de type warning' })
      }}
    >
      Notify warning
    </Button>
    <Button
      ...
      variantColor="danger"
      onClick={() => {
        toast({ ...args, variant: 'danger', content: 'Je suis un toast de type danger' })
      }}
    >
      Notify danger
    </Button>
