...
export default {
  ...
  component: Tag,
  argTypes: {
    icon: { control: { type: 'select', options: Object.values(ICON_NAME) } },
  },
};
...
const AvatarTemplate = () => (
  <Flex gridGap={2} wrap="wrap">
    ...
    <Tag avatar={{ name: 'Dan Abramov', src: 'https://bit.ly/dan-abramov' }} variant="yellow">
      Dan Abramov
    </Tag>
    <Tag avatar={{ name: 'Omar Jbara', props: { bg: 'blue.500', color: 'white' } }} variant="blue">
      Omar Jbara
    </Tag>
  </Flex>
);
  ...
  <Flex gridGap={2} wrap="wrap">
    ...
    <Tag
      avatar={{
        name: 'Erwin Smith',
        src:
          'https://pm1.narvii.com/6981/6dd582abb1862f56713069173d2c2fbe9b9f68bar1-300-300v2_hq.jpg',
      }}
      onRemove={() => {
