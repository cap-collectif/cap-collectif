...
export default {
  ...
  component: Icon,
  argTypes: {
    name: { control: { type: 'select', options: listIconName }, description: 'Name of the icon' },
    size: { control: { type: 'select', options: listIconSize }, description: 'Size of the icon' },
    color: { control: { type: 'color' }, description: 'Color of the icon' },
    className: { control: { type: 'text' }, description: 'Classname' },
  },
};
