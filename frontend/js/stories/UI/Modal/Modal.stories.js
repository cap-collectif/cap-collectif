...
export default {
  ...
  argTypes: {
    ...
    noBackdrop: { control: { type: 'boolean' }, default: false },
    preventBodyScroll: { control: { type: 'boolean' } },
    hideOnClickOutside: { control: { type: 'boolean' }, default: true },
    hideOnEsc: { control: { type: 'boolean' }, default: true },
  },
};
        ...
        <>
          ...
          <Modal.Body>
            ...
            <Text mt={2}>
              ...
              <code>scrollBehavior</code>, accessible dans les knobs de la story. Bref, revenons en
              à Genshin Impact.
            </Text>
            <Text mt={2}>
