...
const Template = (args: any) => (
  <AppBox bg="gray.500" p="40px">
    <Accordion
      spacing={2}
      defaultAccordion={args.defaultAccordion}
...
withDefaultOpen.args = { defaultAccordion: 'volet-2' };

export const withMultipleDefaultOpen = Template.bind({});
withMultipleDefaultOpen.args = { defaultAccordion: ['volet-1', 'volet-2'] };

export const withMultipleOpenAllow = Template.bind({});
withMultipleOpenAllow.args = { allowMultiple: true };
