...
const news = [
  {
    ...
    body:
      "Le 14 février sur CNEWS, la ministre de l'enseignement supérieur Frédérique Vidal déclarait",
  ...
  },
  {
    ...
    body:
      'Benoît HAMON et Gaspard KOENING s’expriment. Le lorem ipsum est, en imprimerie, une suite de mots sans signification utilisée à titre provisoire',
...
storiesOf('Inté client|WhatsNew', module).add(
  ...
  () => (
    <div style={{ maxWidth: '1100px', margin: 'auto' }}>
      <WhatsNew newsArray={arrayObject('newsArray', news)} />
    </div>
  ),
  {
    knobsToBo: {
