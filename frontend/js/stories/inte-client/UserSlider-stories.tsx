...
const inputs = [
  {
    name: 'User 1',
    job: {
      fr: 'PDG/CEO - Renault-Nissan',
      en: 'Yes',
    },
    img: 'https://nextgen.cap-collectif.com/media/default/0001/01/6cacda6bd432b04bb34e3fe9a3a0717484378633.jpeg',
    colors: {
      name: '#40408E',
    },
    lang: 'fr',
...
storiesOf('Inté client/UserSlider/List', module).add(
  'Default',
  () => <UserSlider users={inputs} lang={text('lang', 'fr')} settingsSlider={settingsSlider} />,
  {
    knobsToBo: {
