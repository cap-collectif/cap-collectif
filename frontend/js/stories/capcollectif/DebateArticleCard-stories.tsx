...
storiesOf('Cap Collectif/ DebateArticleCard', module)
  .add('default', () => {
    return (
      <DebateArticleCard maxWidth={365} publishedAt="19 oct 2020" illustration="https://picsum.photos/536/354">
        <DebateArticleCard.Title>Que pèse vraiment le marché du cannabis en France ?</DebateArticleCard.Title>
    ...
    return (
      <DebateArticleCard maxWidth={365} publishedAt="19 oct 2020" illustration="https://picsum.photos/536/354">
        ...
        <DebateArticleCard.Description>
          Le lorem ipsum est, en imprimerie, une suite de mots sans signification utilisée à titre provisoire blab bla
          bla dla pookie tu connais la chanson
        </DebateArticleCard.Description>
        <DebateArticleCard.Origin>BFM TV</DebateArticleCard.Origin>
      </DebateArticleCard>
    )
  ...
  .add('without description', () => {
    return (
      <DebateArticleCard maxWidth={365} illustration="https://picsum.photos/536/354" publishedAt="19 oct 2020">
        <DebateArticleCard.Title>Que pèse vraiment le marché du cannabis en France ?</DebateArticleCard.Title>
        <DebateArticleCard.Origin>BFM TV</DebateArticleCard.Origin>
      </DebateArticleCard>
    )
  ...
  .add('grouped', () => {
    return (
      ...
      >
        ...
        <DebateArticleCard publishedAt="il y a 19 heures" illustration="https://picsum.photos/536/354">
          <DebateArticleCard.Title>Que pèse vraiment le marché du cannabis en France ?</DebateArticleCard.Title>
          <DebateArticleCard.Origin>BFM TV</DebateArticleCard.Origin>
        </DebateArticleCard>
        <DebateArticleCard publishedAt="un jour peut être" illustration="https://picsum.photos/536/354">
          <DebateArticleCard.Title>Que pèse vraiment le marché du cannabis en France ?</DebateArticleCard.Title>
          <DebateArticleCard.Origin>BFM TV</DebateArticleCard.Origin>
        </DebateArticleCard>
      </Grid>
