    ...
    <Card.Body>
      <Media>
        ...
        <Media.Body>
          ...
          <p className="excerpt small">{user ? <span>{`${user.contributionsCount} contributions`}</span> : null}</p>
        </Media.Body>
      </Media>
    </Card.Body>
  </Card>
  ...
  <div>
    ...
    {hasMore && (
      <div className="text-center">
        <button type="button" disabled={isLoading} onClick={() => {}} className="text-center btn btn-secondary">
