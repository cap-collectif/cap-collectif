...
export const event = {
  ...
  themes: [{ id: '1', title: 'Immobilier' }, { id: '2', title: 'Justice' }],
  author,
};
...
export const events = [
  {
    title:
      'Lorem ipsum dolor sit amet, et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi',
    url: '#',
    media: {
      url: 'https://picsum.photos/300/400',
    },
