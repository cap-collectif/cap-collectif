...
storiesOf('Core/Form/Checkbox', module).add('With image', () => {
  return <Checkbox id="1" name="test" image="https://source.unsplash.com/random/300x200" value="test1" />
})
storiesOf('Core/Form/Checkbox', module).add('With image checked', () => {
  return <Checkbox id="1" name="test" image="https://source.unsplash.com/random/300x200" value="test1" checked />
})
...
storiesOf('Core/Form/Radio', module).add('With image', () => {
  return <Radio id="1" name="test" image="https://source.unsplash.com/random/300x200" value="test1" />
})
storiesOf('Core/Form/Radio', module).add('With image checked', () => {
  return <Radio id="1" name="test" image="https://source.unsplash.com/random/300x200" value="test1" checked />
})
...
storiesOf('Core/Form/RadioButton', module).add('Default', () => {
  return <Radio label="Je ne suis pas checked" id="2" name="test" value="test2" color="#0AA900" isButton />
})
storiesOf('Core/Form/RadioButton', module).add('Checked', () => {
  return <Radio label="Je suis checked" id="2" name="test" value="test2" color="#0AA900" checked isButton />
})
...
storiesOf('Core/Form/Toggle', module).add('Default', () => {
  return <Toggle id="1" name="test" value="test1" label="Toggler" helpText="Je suis un text d'aide" />
})
...
storiesOf('Core/Form/Toggle', module).add('Disabled', () => {
  return <Toggle id="3" name="test" value="test3" label="Toggler" disabled helpText="Je suis un text d'aide" />
})
