...
storiesOf('Core|Form/Description', module).add('Default', () => {
  return (
    <Description typeForm={TYPE_FORM.QUESTIONNAIRE}>
      Un hamstéroïde hahaha (voir composant question)
    </Description>
  );
});
...
storiesOf('Core|Form/Help', module).add('Default', () => {
  return (
    <Help typeForm={TYPE_FORM.QUESTIONNAIRE}>
      “There are only two hard things in Computer Science: cache invalidation and naming things” de
      Phil Karlton
    </Help>
  );
});
