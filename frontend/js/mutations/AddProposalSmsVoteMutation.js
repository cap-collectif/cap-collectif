...
const commit = (
  variables: AddProposalSmsVoteMutationVariables,
): Promise<AddProposalSmsVoteMutationResponse> =>
    ...
    updater: (store: RecordSourceSelectorProxy) => {
      ...
      const updatedViewerVotes = voteEdge
        ...
        ?.getLinkedRecord('viewerVotes', {
          orderBy: { field: 'POSITION', direction: 'ASC' }, token: variables.input.token
        })
