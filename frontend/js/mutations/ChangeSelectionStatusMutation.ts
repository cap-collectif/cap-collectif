...
} from '~relay/ChangeSelectionStatusMutation.graphql'
...
const commit = (variables: ChangeSelectionStatusMutationVariables): Promise<ChangeSelectionStatusMutationResponse> =>
