...
import type { AddCommentMutationVariables, AddCommentMutationResponse } from '~relay/AddCommentMutation.graphql'
...
const commit = (variables: AddCommentMutationVariables): Promise<AddCommentMutationResponse> =>
  commitMutation(environment, {
    ...
    updater: (store: RecordSourceSelectorProxy) => {
      ...
      const answersConnection = ConnectionHandler.getConnection(commentableProxy, 'CommentAnswers_answers')
