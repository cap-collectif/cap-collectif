...
const commit = (
  ...
  commitMutation(environment, {
    ...
    updater: (store: RecordSourceSelectorProxy) => {
      ...
      const senderEmailDomainAddedId = senderEmailDomainAdded.getValue('id') as any as DataID
      const newSenderEmailDomain = store.get(senderEmailDomainAddedId)
      rootFields.setLinkedRecords([...senderEmailDomains, newSenderEmailDomain], 'senderEmailDomains')
    },
  })
