...
const mutation = graphql`
  mutation UpdateExternalServiceConfigurationMutation(
...
const commit = (
  ...
  commitMutation(environment, {
    ...
    optimisticUpdater: (store: RecordSourceSelectorProxy) => {
      const externalServiceConfigurationProxy = store
        .getRoot()
        .getLinkedRecord('externalServiceConfiguration', { type: 'MAILER' });
    ...
    updater: (store: RecordSourceSelectorProxy) => {
      ...
      const externalServiceConfigurationUpdated = payload.getLinkedRecord(
        'externalServiceConfiguration',
      );
