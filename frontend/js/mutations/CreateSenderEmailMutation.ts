...
const commit = (variables: CreateSenderEmailMutationVariables): Promise<CreateSenderEmailMutationResponse> =>
  commitMutation(environment, {
    ...
    updater: (store: RecordSourceSelectorProxy) => {
      ...
      const senderEmailAddedId = senderEmailAdded.getValue('id') as any as DataID
