...
const mutation = graphql`
  mutation ChangeSiteFaviconMutation($input: ChangeSiteFaviconInput!) {
...
const commit = (variables: ChangeSiteFaviconMutationVariables): Promise<ChangeSiteFaviconMutationResponse> =>
