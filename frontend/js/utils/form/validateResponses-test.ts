...
import { allTypeQuestions, allTypeResponses, allTypeQuestionsWithRule, allTypeResponsesWithError } from './mocks'
...
describe('validateResponses', () => {
  ...
  it('should work correctly with all questions not required and right responses', () => {
    const availableQuestionsIds = getAvailableQuestionsIds(allNotRequiredQuestions, allTypeResponses)
    const errors = validateResponses(
  ...
  it('should render all type error', () => {
    const availableQuestionsIds = getAvailableQuestionsIds(allTypeQuestionsWithRule, allTypeResponsesWithError)
    const errors = validateResponses(
