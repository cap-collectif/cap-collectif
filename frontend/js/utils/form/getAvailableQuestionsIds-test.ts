...
const ALL_CASE_QUESTIONNAIRE = {
  ...
  manyAlwaysJump: {
    form: manyAlwaysJump,
    result: ['UXVlc3Rpb246NDg3', 'UXVlc3Rpb246NDky', 'UXVlc3Rpb246NDkx', 'UXVlc3Rpb246NDk2', 'UXVlc3Rpb246NDk1'],
  },
  onlyJump: {
    form: onlyJump,
    responses: [
      {
        ...
        value: {
          value: 'Jump to question 3',
          label: 'Jump to question 3',
        },
      },
    ],
    ...
    responses: [
      {
        question: 'UXVlc3Rpb246NDg3',
        value: {
          value: 'Jump to question 2',
          label: 'Jump to question 2',
        },
      },
      {
        question: 'UXVlc3Rpb246NDkz',
        value: {
          value: 'Afficher question 5',
          label: 'Afficher question 5',
        },
      },
    ],
    result: [
...
describe('getAvailableQuestionsIds', () => {
  ...
  it('GET ALL SIMPLE Q EVEN BETWEEN Q JUMP - should render correctly', () => {
    const ids = getAvailableQuestionsIds(ALL_CASE_QUESTIONNAIRE.getSimpleWithManySimpleAndManyJump.form, [])
