  ...
  (typeof window !== 'object' || window !== _global
    ...
    ? function saveAs(blob, name, opts) {
        ...
        if (typeof blob === 'string') {
          ...
          /* @ts-expect-error  this function is deprecated and will be deleted in the future , that's why flow doesn't recognise it. we keep it in for users with old systems */
          navigator.msSaveOrOpenBlob(bom(blob, opts), name)
        }
      } // Fallback to using FileReader and a popup
    : function saveAs(blob, name, opts, popup: any) {
