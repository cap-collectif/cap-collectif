import type { AddressComplete, AddressCompleteFormatted, AddressType } from '~/components/Form/Address/Address.type'
import type { MapCenterObject } from '~/components/Proposal/Map/Map.types'

export const getCityFromGoogleAddress = (address: AddressCompleteFormatted): string | null | undefined => {
...
export const getDataFromGoogleAddress = (address: AddressCompleteFormatted, typeSelected: AddressType): string => {
