...
const ProposalFormAdminPageTabsContainer: StyledComponent<{}, {}, HTMLDivElement> = styled.div`
  h1 {
    font-size: 18px;
    font-weight: 600;
...
export const NavContainer: StyledComponent<
...
export const NavItem: StyledComponent<{}, {}, HTMLLIElement> = styled.li`
  margin-right: 20px;
