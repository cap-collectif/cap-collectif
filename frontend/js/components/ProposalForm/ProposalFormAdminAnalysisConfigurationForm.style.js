...
const ProposalFormAdminContainer: StyledComponent<{}, {}, HTMLFormElement> = styled.form`
  .react-select__menu {
    z-index: 3;
  }
`;

export const Badge: StyledComponent<{ color: string }, {}, HTMLDivElement> = styled.div`
  display: inline-flex;
  align-items: center;
...
export const MoveStepContainer: StyledComponent<{}, {}, HTMLDivElement> = styled.div`
  display: flex;
...
export const MoveStatusContainer: StyledComponent<
...
export const ButtonResetMoveStep: StyledComponent<{}, {}, HTMLButtonElement> = styled.button`
  display: flex;
  align-items: center;
  justify-content: center;
  border: none;
...
export const CustomDateContainer: StyledComponent<{}, {}, HTMLDivElement> = styled.div`
  margin-left: 15px;
