...
const CoverPage = ({logoUrl, url, title, translations}: Props) => {
  ...
  return (
    <>
      <View style={{width: '100%', marginTop: 100, textAlign: 'center'}}>
       ...
       <View style={{position: 'absolute', bottom: 0, paddingVertical: 8, backgroundColor: '#F7F7F8', width: '100vw', textAlign: 'center' }}>
