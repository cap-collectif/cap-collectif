          ...
          {relay.hasMore() && (
            <div className="w-100 text-center">
              {loading ? (
                ...
                <Button bsStyle="primary" className="btn-outline-primary" onClick={this.handleLoadMore}>
...
export default createPaginationContainer(
  ...
  },
  {
    ...
    getVariables(props: Props, { count, cursor }, fragmentVariables) {
      return { ...fragmentVariables, count, cursor, questionId: props.mediaQuestion.id }
    },
