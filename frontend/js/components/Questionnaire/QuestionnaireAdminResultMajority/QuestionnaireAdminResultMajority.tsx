...
import { Container, ColorRow, GraphContainer, ResponseContainer } from './QuestionnaireAdminResultMajority.style'
        ...
        <Container active isMobile={isMobile}>
          <GraphContainer>
            <div className="median-mention">
              <FormattedMessage id="median-mention" /> <FormattedMessage id={resultVoteMajority[median].label} />
            </div>
