...
export const ColorRow: StyledComponent<{}, {}, HTMLDivElement> = styled.div.attrs({
  className: 'color-row',
})`
  margin-top: 10px;
  height: 60px;
...
export const GraphContainer: StyledComponent<{}, {}, HTMLDivElement> = styled.div.attrs({
...
export const ResponseContainer: StyledComponent<{}, {}, HTMLDivElement> = styled.div.attrs({
