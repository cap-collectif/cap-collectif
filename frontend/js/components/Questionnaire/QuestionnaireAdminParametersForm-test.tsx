...
describe('<QuestionnaireAdminParametersForm />', () => {
  ...
  it('renders correctly with anonymous allowed', () => {
    const wrapper = shallow(
      <QuestionnaireAdminParametersForm {...formMock} {...questionnaireProps} initialValues={initialValues1} />,
    )
    expect(wrapper).toMatchSnapshot()
  })
  it('renders correctly with anonymous not allowed', () => {
    const wrapper = shallow(
      <QuestionnaireAdminParametersForm {...formMock} {...questionnaireProps} initialValues={initialValues2} />,
    )
    expect(wrapper).toMatchSnapshot()
  })
})
