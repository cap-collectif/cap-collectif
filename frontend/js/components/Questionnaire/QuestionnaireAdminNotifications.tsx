...
import '~relay/QuestionnaireAdminNotifications_questionnaire.graphql'
...
type QuestionnaireProps = {
  readonly questionnaire: QuestionnaireAdminNotifications_questionnaire
}
type QuestionnaireFragmentProps = {
  readonly questionnaire: QuestionnaireAdminNotifications_questionnaire$key
  readonly viewer: QuestionnaireAdminNotifications_viewer$key
}
type Props = ReduxFormFormProps & QuestionnaireFragmentProps

const onSubmit = (values: Record<string, any>, dispatch: Dispatch, props: QuestionnaireProps) => {
      ...
      <div className="box-content">
        <form onSubmit={handleSubmit}>
          <h4 className="mb-3 mt-20">
            {intl.formatMessage({
              id: 'notification.answer.created',
            })}
          </h4>
          <Field
          ...
          >
            {intl.formatMessage({
              id: 'proposal_form.notifications.on_create',
            })}
          </Field>
          <Field
...
const container = injectProp(form) as React.AbstractComponent<QuestionnaireFragmentProps>
