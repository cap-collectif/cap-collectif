...
import '~relay/QuestionnairePage_questionnaire.graphql'
...
export const QuestionnairePage = ({ questionnaire, query }: Props) => {
  ...
  return questionnaire && query ? (
    <QuestionnaireContainer className="questionnaire-page" id={`questionnaire-${questionnaire.id || ''}`}>
      ...
      {showCreateForm && <ReplyCreateFormWrapper questionnaire={questionnaire} setIsShow={setIsShow} />}
