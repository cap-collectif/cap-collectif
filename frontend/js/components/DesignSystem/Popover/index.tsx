...
type Props = AppBoxProps &
  TippyPlacementProps & {
    readonly trigger?: ReadonlyArray<'mouseenter' | 'focus' | 'click' | 'focusin' | 'manual'>
    ...
    readonly onShow?: (instance: any) => void | false
    readonly onHide?: (instance: any) => void | false
    children?: any
    isDisabled?: boolean
  }
...
const Popover = ({
  ...
  const popoverChildren = React.Children.toArray(children).find(child => child.type.name === POPOVER_CONTENT_TYPE)
  ...
  return triggerChild ? (
    <Tippy
      ...
      render={attrs => (
        ...
        >
          {popoverChildren && // @ts-ignore
            React.cloneElement(popoverChildren, {
              closePopover: tippyInstance?.unmount,
            })}
