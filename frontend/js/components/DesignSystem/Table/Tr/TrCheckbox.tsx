...
const TrCheckbox = ({ rowId, inHead, checkboxLabel }: TrCheckboxProps): JSX.Element => {
  const { dispatch, isRowChecked, hasIndeterminateState, hasAllRowsChecked, isLoading } = useTable()
  const intl = useIntl()
