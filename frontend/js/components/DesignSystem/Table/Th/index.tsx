...
type ThProps = AppBoxProps & {
  isNumeric?: boolean
  noPlaceholder?: boolean
  children?: JSX.Element | JSX.Element[] | string | ((arg0: { styles: DefaultStyles }) => React.ReactNode)
}
...
const Th = ({ isNumeric, noPlaceholder, children, ...props }: ThProps): JSX.Element => {
