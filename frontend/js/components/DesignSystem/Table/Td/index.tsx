...
type TdProps = AppBoxProps & {
  isNumeric?: boolean
  visibleOnHover?: boolean
  noPlaceholder?: boolean
  children: (string | null | undefined) | (JSX.Element | null | undefined)
}
const styles = css({
  a: {
    textDecoration: 'none ',
...
const Td = ({ isNumeric, visibleOnHover, noPlaceholder, children, ...props }: TdProps): JSX.Element => {
  ...
  return (
    <AppBox
      ...
      style={{
        whiteSpace: isNumeric ? 'nowrap' : 'initial',
      }}
      className={cn({
        'visible-on-hover': visibleOnHover,
      })}
      css={styles}
      lineHeight="base"
      {...props}
