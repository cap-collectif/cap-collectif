...
type Props = {
  ...
  readonly argumentable: ArgumentListView_argumentable
  ...
  _refetch = (newOrder: ArgumentSelectOrder) => {
    ...
    const refetchVariables = (fragmentVariables: FragmentVariables) =>
      ({
        ...
        cursor: null,
        orderBy,
      } as ArgumentListViewRefetchQueryVariables)
    ...
    argumentable: graphql`
      ...
      @argumentDefinitions(
        ...
        ...ArgumentListViewPaginated_argumentable
          @arguments(isAuthenticated: $isAuthenticated, cursor: $cursor, count: $count, orderBy: $orderBy, type: $type)
      }
    `,
  },
  graphql`
    query ArgumentListViewRefetchQuery(
      ...
      argumentable: node(id: $argumentableId) {
        ...
        ...ArgumentListView_argumentable
          @arguments(cursor: $cursor, count: $count, type: $type, orderBy: $orderBy, isAuthenticated: $isAuthenticated)
      }
    }
  `,
)
