    ...
    return (
      <div id={`arguments-col--${type}`}>
        <div className="opinion opinion--add-argument block block--bordered">
          <ArgumentCreate form={`create-argument-${type}`} type={type} argumentable={argumentable} />
        </div>
        {/** @ts-ignore */}
...
export default createFragmentContainer(ArgumentsBox, {
  opinion: graphql`
    fragment ArgumentsBox_opinion on OpinionOrVersion @argumentDefinitions(isAuthenticated: { type: "Boolean!" }) {
