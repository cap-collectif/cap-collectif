...
import '~/components/Analysis/AnalysisProposalListRole/AnalysisProposalListRole'
import type { Badge } from '~/components/User/UserAvatar'
import '~/components/User/UserAvatar'

export const getStatus = (
  analyses: ReadonlyArray<Record<string, any>> | null | undefined,
  idUser: string,
...
export const getHeadStatus = (
  analyse: Record<string, any> | null | undefined,
