      ...
      <ProposalInformationsContainer>
        <ProposalListRowHeader>
          {(proposal.draft || proposal.trashed) && hasStateTag && (
            <StateTag>
              {intl.formatMessage({
                id: proposal.draft ? 'admin.fields.proposal.draft' : 'admin.fields.proposal.isTrashed',
              })}
            </StateTag>
          )}
          ...
          <h2 className="d-flex align-items-center">
            {proposal.revisions && proposal.revisions.totalCount > 0 && (
              ...
              >
                <Flex mr="10px">
                  <Icon name={ICON_NAME.information} size={pxToRem(14)} color={styleGuideColors.blue200} />
                </Flex>
              </Tooltip>
            )}
            <a href={isAdminView ? proposal?.adminUrl ?? proposal.url : proposal.url}>{proposal.title}</a>
          </h2>
        </ProposalListRowHeader>
          ...
          <p>
            ...
            {proposal.publishedAt && (
              <React.Fragment>
                ...
                •{' '}
                {intl.formatMessage({
                  id: isOpinion ? 'published-on' : 'submited_on',
                })}{' '}
                <FormattedDate value={moment(proposal.publishedAt)} day="numeric" month="long" year="numeric" />
              </React.Fragment>
            )}
          </p>
        </ProposalListRowInformations>
            ...
            <ProposalTag
              ...
              onClick={() =>
                dispatch({
                  ...
                  payload: proposal.district?.id as any as ProposalsDistrictValues,
                })
              }
            >
            ...
            <ProposalTag
              ...
              onClick={() =>
                dispatch({
                  ...
                  payload: proposal.theme?.id as any as ProposalsThemeValues,
                })
              }
            >
            ...
            <ProposalTag
              ...
              onClick={() =>
                dispatch({
                  ...
                  payload: proposal.category?.id as any as ProposalsCategoryValues,
                })
              }
            >
