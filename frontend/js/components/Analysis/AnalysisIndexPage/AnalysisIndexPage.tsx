...
import type { OrderDirection, ProposalOrderField } from '~relay/ProjectAdminProposalsPageQuery.graphql'
...
const createQueryVariables = (
  ...
  AnalysisProjectPageProposalsPaginatedQueryVariables,
  {
    projectId: any
  }
> => ({
...
export const renderComponent = ({
  ...
  props: AnalysisIndexPageQueryResponse | null | undefined
  parameters: AnalysisProjectPageParameters
  language: string
}) => {
  ...
  return (
    <Router basename={`/${languageUrl}${BASE_URL_ANALYSIS}`}>
      ...
      <Route
        exact
        path={allPaths}
        component={routeProps => <AnalysisHeader countProject={projects.length || 0} {...routeProps} />}
      />
        ...
        <Route exact path={PATHS.INDEX}>
          {projects.length === 1 ? (
            ...
            <Skeleton
              ...
              placeholder={
                <AnalysisPageContentPlaceholder isIndexPage hasError={hasError} fetchData={retry} selectedTab={null} />
              }
            >
...
export default connect<any, any>(mapStateToProps)(AnalysisIndexPage)
