...
import { Container, Header } from '~/components/Analysis/AnalysisProjectPage/AnalysisProjectPage.style'
...
import type { StateValues } from './AnalysisProjectPage.reducer'
import { STATE } from './AnalysisProjectPage.reducer'
import { getDifferenceFilters, getWordingEmpty, getFormattedProposalsWithTheme } from './AnalysisProjectPage.utils'
...
const AnalysisProjectPage = ({ project, themes = [], defaultUsers, relay, history }: Props) => {
  const { sortedProposals: dataProposals, viewerProposalsTodo, viewerProposalsDone, viewerProposalsAll } = project
        ...
        <InlineSelect
          ...
          onChange={newValue =>
            dispatch({
              ...
              payload: newValue as any as StateValues,
            })
          }
        >
      ...
      <PickableList.Provider>
        ...
        >
          <AnalysisProposalListHeaderContainer disabled={!hasSelectedFilters && !hasProposals}>
            <AnalysisDashboardHeader project={project} defaultUsers={defaultUsers} themes={themes} />
