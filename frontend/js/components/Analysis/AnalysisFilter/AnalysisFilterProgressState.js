      ...
      <Collapsable.Element ariaLabel={intl.formatMessage({ id: 'filter-by' })}>
        <DropdownSelect
          ...
          <DropdownSelect.Choice value="TODO">
            {intl.formatMessage({ id: PROPOSAL_STATUS.TODO.label })}
          </DropdownSelect.Choice>
          <DropdownSelect.Choice value="IN_PROGRESS">
            {intl.formatMessage({ id: PROPOSAL_STATUS.IN_PROGRESS.label })}
          </DropdownSelect.Choice>
          <DropdownSelect.Choice value="FAVOURABLE">
            {intl.formatMessage({ id: PROPOSAL_STATUS.FAVOURABLE.label })}
          </DropdownSelect.Choice>
          <DropdownSelect.Choice value="UNFAVOURABLE">
            {intl.formatMessage({ id: PROPOSAL_STATUS.UNFAVOURABLE.label })}
          </DropdownSelect.Choice>
        </DropdownSelect>
      </Collapsable.Element>
    </Collapsable>
