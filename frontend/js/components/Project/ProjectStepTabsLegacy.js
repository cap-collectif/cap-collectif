...
import type { ProjectStepTabsLegacy_project$key } from '~relay/ProjectStepTabsLegacy_project.graphql';
import { fromGlobalId } from '~/utils/fromGlobalId';

export type Props = {|
  project: ProjectStepTabsLegacy_project$key,
|};
const FRAGMENT = graphql`
  fragment ProjectStepTabsLegacy_project on Project {
    steps {
      id
      state
      label
...
`;
const ProjectStepTabsLegacy = ({ project }: Props): React.Node => {
...
export default ProjectStepTabsLegacy;
