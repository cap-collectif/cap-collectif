...
type Props = {
  ...
  readonly second?: DateStyleNumeric
  readonly minute?: DateStyleNumeric
  readonly hour?: DateStyleNumeric
  readonly day?: DateStyleNumeric
  readonly month?: DateStyleNumeric | 'long' | 'short' | 'narrow'
  readonly year?: DateStyleNumeric
}
  ...
  render() {
    ...
    const startDay = (
      <FormattedDate
        ...
        day={day}
        month={month}
        year={!showCurrentYear && now.getFullYear() === startAtDate.getFullYear() ? undefined : year}
      />
    )
