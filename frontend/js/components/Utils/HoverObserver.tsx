...
class HoverObserver extends React.Component<Props, State> {
  ...
  static defaultProps = {
    ...
    hoverOffDelayInMs: 0,
    onHoverChanged: noop,
    onMouseEnter: ({ setIsHovering }: Record<string, any>) => setIsHovering(),
    onMouseLeave: ({ unsetIsHovering }: Record<string, any>) => unsetIsHovering(),
    onMouseOver: noop,
    onMouseOut: noop,
  }
  ...
  renderChildrenWithProps(children: React.ReactElement<any>, props: Props) {
