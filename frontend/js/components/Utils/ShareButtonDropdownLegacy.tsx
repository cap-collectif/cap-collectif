...
const ShareButtonDropdownLegacy = ({ id = 'share-button', title = '', url, enabled, bsSize, disabled }: Props) => {
    ...
    <Menu placement="bottom-start" className="share-button-dropdown">
      <Menu.Button>
        <Button
          ...
          leftIcon={<Icon name={ICON_NAME.SHARE} size={bsSize === 'xs' ? ICON_SIZE.XS : ICON_SIZE.SM} />}
          variant="tertiary"
