...
import { updateSyncErrors, type FieldProps } from 'redux-form';
...
type FileUploadFieldProps = {
  ...
  onPostDrop: (media: { id: string, name: string, url: string }, input: Object) => void,
  disabled: boolean,
    ...
    <FormGroup>
      ...
      {input.value.importableProposals && (
        <Card paddingTop={2} paddingBottom={0} paddingX={0} width="100%" border="none">
          <InfoMessage variant="success" style={{ wordWrap: 'anywhere' }}>
      ...
      {input.value.errorCode && (
        <Card paddingTop={2} paddingBottom={0} paddingX={0} width="100%" border="none">
          <InfoMessage variant="danger" style={{ wordWrap: 'anywhere' }}>
            <InfoMessage.Title withIcon>
      ...
      {input.value.duplicates && (
        <Card paddingTop={2} paddingBottom={0} paddingX={0} width="100%" border="none">
          <InfoMessage variant="warning" style={{ wordWrap: 'anywhere' }}>
            <InfoMessage.Title withIcon>
              {intl.formatMessage(
