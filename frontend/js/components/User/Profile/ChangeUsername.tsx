...
import '~relay/ChangeUsername_viewer.graphql'
...
export class ChangeUsername extends Component<Props> {
  render() {
    const { invalid, valid, submitSucceeded, submitFailed, handleSubmit, submitting, error } = this.props
    return (
