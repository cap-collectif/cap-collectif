...
const onSubmit = (values: FormValues, dispatch: Dispatch, props: Props) => {
  ...
  return RemoveSsoMutation.commit({
    input,
  }).then((response: RemoveSsoMutationResponse) => {
...
export const validate = (values: FormValues, props: Props) => {
  ...
  if (props.viewer && !props.viewer.hasPassword && (!values.plainPassword || values.plainPassword.length < 1)) {
