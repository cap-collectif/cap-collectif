...
import {
  MetaStepNavigation,
  MetaStepNavigationShare,
  MetaStepNavigationTitle,
  MetaStepNavigationBackButton,
} from './MetaStepNavigation';
import { $refType } from '../../mocks';

const cStep = {
  __typename: 'ConsultationStep',
  url:
    'https://capco.dev/project/strategie-technologique-de-letat-et-services-publics/consultation/etape-de-multi-consultation',
  consultation: {
    url:
      'https://capco.dev/project/strategie-technologique-de-letat-et-services-publics/consultation/etape-de-multi-consultation/consultation/deuxieme-consultation',
