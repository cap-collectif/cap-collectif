...
import type { VersionOrder } from './OpinionVersionListView'
import OpinionVersionListView from './OpinionVersionListView'
              ...
              <Panel.Title>
                <strong>
                  <FormattedMessage
                    id="global.versions"
                    values={{
                      num: opinion.viewerVersionsUnpublished.totalCount,
                    }}
                  />
                </strong>{' '}
        ...
        <Panel>
          ...
          <QueryRenderer
            ...
            variables={
              ...
              } as OpinionVersionsBoxQueryVariables
            }
            render={({
              error,
              props,
            }: ReactRelayReadyState & {
              props?: OpinionVersionsBoxQueryResponse | null | undefined
            }) => {
              if (error) {
                return graphqlError
              }
...
export default createFragmentContainer(OpinionVersionsBox, {
  opinion: graphql`
    fragment OpinionVersionsBox_opinion on Opinion @argumentDefinitions(isAuthenticated: { type: "Boolean!" }) {
      id
