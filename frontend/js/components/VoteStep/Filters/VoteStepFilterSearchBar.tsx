...
import type { AddressComplete, AddressWithoutPosition } from '~/components/Form/Address/Address.type'
          ...
          >
            ...
            >
              {hasLocationAuthorize ? (
                ...
                <Icon name={CapUIIcon.LocationTargetRefused} size={CapUIIconSize.Md} color="gray.900" />
              )}
            </Box>
            <Box
              as="input"
