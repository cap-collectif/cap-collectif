...
const CardSkeleton = ({ showImages }: Props) => (
  <Card>
    <Flex justify="space-between">
      <Flex direction="column" width={['100%', '100%', '100%', showImages ? 'calc(50% - 4rem)' : '100%']}>
...
export const ProposalsListSkeleton = ({ showImages = false }: Props) => (
  <Box maxHeight={['100%', '100vh']} overflowY="hidden" pt={['7rem', 0]} px={[4, 8]} id="proposals-list-skeleton">
