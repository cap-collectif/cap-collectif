...
export class Cookie extends React.Component<Props, CookieState> {
  constructor(props: Props) {
    ...
    this.state = {
      ...
      isAnalyticEnabled:
        config.canUseDOM &&
        (typeof CookieMonster.analyticCookieValue() === 'undefined' || CookieMonster.analyticCookieValue() === false
          ? false
          ...
          {analyticsJs && analyticsJs.length > 1 && (
            ...
            >
              ...
              <Col sm={4} className="d-flex justify-content-end cookie-manager">
                <div
                  className={isAnalyticEnabled ? 'color-green cookie-manager mr-10' : 'color-red cookie-manager mr-10'}
                >
                  <FormattedMessage id={isAnalyticEnabled ? 'list.label_enabled' : 'global.disabled'} />
                </div>
                <Toggle
          ...
          {adJs && adJs.length > 1 && (
            ...
            >
              ...
              <Col sm={4} className="d-flex justify-content-end cookie-manager">
                <div
                  className={
                    isAdvertisingEnabled ? 'color-green cookie-manager mr-10' : 'color-red cookie-manager mr-10'
                  }
                >
                  <FormattedMessage id={isAdvertisingEnabled ? 'list.label_enabled' : 'global.disabled'} />
                </div>
                <Toggle
