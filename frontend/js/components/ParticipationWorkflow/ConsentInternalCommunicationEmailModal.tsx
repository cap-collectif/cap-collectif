...
} from '~/mutations/SendParticipantConsentInternalCommunicationEmailMutation'
...
const ConsentInternalCommunicationEmailModal = () => {
  ...
  const intl = useIntl();
  const sendParticipantConsentInternalCommunicationEmailMutation = useSendParticipantConsentInternalCommunicationEmailMutation()
