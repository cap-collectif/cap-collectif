...
import { Button, CapUIIcon, CapUIIconSize, CapUIModalSize, Icon, Modal, Heading } from '@cap-collectif/ui'
    ...
    <>
      <Modal
        ...
        disclosure={
          ...
          >
            <Icon aria-hidden={true} name={CapUIIcon.CrossO} size={CapUIIconSize.Md} color="gray.900" />
          </Button>
        }
      >
        {({ hide }) => (
