...
type Props = {
  readonly version: OpinionVersionFollowersBox_version
...
export default createPaginationContainer(
  OpinionVersionFollowersBox,
  {
    version: graphql`
      ...
      @argumentDefinitions(count: { type: "Int", defaultValue: 20 }, cursor: { type: "String", defaultValue: null }) {
        id
        followers(first: $count, after: $cursor) @connection(key: "OpinionVersionFollowersBox_followers") {
          edges {
            cursor
            node {
              id
