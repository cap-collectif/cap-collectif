...
import type { OpinionPageQueryVariables, OpinionPageQueryResponse } from '~relay/OpinionPageQuery.graphql'
export type Props = {
  opinionId?: string
  versionId?: string
          ...
          variables={
            {
              opinionId: id,
              isAuthenticated,
            } as OpinionPageQueryVariables
          }
          render={({
            error,
            props,
          }: ReactRelayReadyState & {
            props: OpinionPageQueryResponse | null | undefined
          }) => {
            if (error) {
              return graphqlError
            }
