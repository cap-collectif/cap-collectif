...
describe('<OpinionVotesButton />', () => {
  ...
  it('should render a green button when value is 1 and vote type is both', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteBoth} value="YES" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render an orange button when value is 0 and vote type is both', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteBoth} value="MITIGE" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render a red button when value is -1 and vote type is both', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteBoth} value="NO" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render a green button when value is 1 and vote type is simple', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteSimple} value="YES" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should not render a button when value is 0 and vote type is simple', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteSimple} value="MITIGE" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should not render a button when value is -1 and vote type is simple', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteSimple} value="NO" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should not render a button when value is 1 and vote type is disabled', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteDisabled} value="YES" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should not render a button when value is 0 and vote type is disabled', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteDisabled} value="MITIGE" />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should not render a button when value is -1 and vote type is disabled', () => {
    const wrapper = shallow(<OpinionVotesButton {...defaultProps} opinion={opinionVoteDisabled} value="NO" />)
    expect(wrapper).toMatchSnapshot()
  })
})
