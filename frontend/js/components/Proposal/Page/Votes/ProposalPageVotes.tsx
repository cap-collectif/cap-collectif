...
export const ProposalPageVotes = ({ proposal, setGlobalVotesCount }: Props) => {
  const intl = useIntl()
  const [selectedStep, setSelectedStep] = useState<Step | null | undefined>(proposal?.votableSteps[0])
              ...
              <h5>
                {intl.formatMessage(
                  ...
                  },
                  {
                    ...
                    paperVotesCount: paperVotesTotalCount,
                  },
                )}
              </h5>
            ) : (
                ...
                {proposal.votableSteps.map((votableStep, index) => (
                  <Menu.Item
                    ...
                    onClick={() => {
                      ...
                      fetchQuery_DEPRECATED(environment, query, {
                        proposalId: proposal.id,
                        stepId: votableStep.id,
                      } as ProposalPageVotesTotalCountQueryVariables).then(
                        (data: ProposalPageVotesTotalCountQueryResponse) => {
