...
type Props = {|
  ...
  +onClose?: () => void,
  +proposal: ProposalNewsCreateModal_proposal,
|};
...
export const ProposalNewsCreateModal = ({
  ...
  const onSubmit = (values: FormValues) => {
    ...
    return AddProposalNewsMutation.commit({ input: data })
...
export default createFragmentContainer(
  connect<any, any, _, _, _, _>(mapStateToProps)(ProposalNewsCreateModal),
  {
    proposal: graphql`
