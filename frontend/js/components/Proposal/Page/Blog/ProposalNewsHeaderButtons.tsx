  ...
  return (
    <QueryRenderer
      ...
      variables={
        {
          postId,
        } as ProposalNewsHeaderButtonsQueryVariables
      }
      render={({
        error,
        props,
      }: ReactRelayReadyState & {
        props: ProposalNewsHeaderButtonsQueryResponse | null | undefined
      }) => {
        ...
        if (props && props.post) {
          return (
            <Flex maxWidth="690px" width="100%" margin="auto" px={11}>
              ...
              <ProposalNewsEditModal post={props.post} show={showModal} displayModal={displayModal} />
            </Flex>
          )
        }
