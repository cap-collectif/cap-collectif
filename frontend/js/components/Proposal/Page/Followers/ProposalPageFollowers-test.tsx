...
describe('<ProposalPageFollowers />', () => {
  ...
  it('should render a proposal page follower with users', () => {
    const wrapper = shallow(<ProposalPageFollowers proposal={proposalWithUsers} pageAdmin={pageAdmin} {...props} />)
  ...
  it('should render a proposal page follower without users', () => {
    const wrapper = shallow(<ProposalPageFollowers proposal={proposalWithoutUsers} pageAdmin={pageAdmin} {...props} />)
    expect(wrapper).toMatchSnapshot()
  })
})
