...
describe('<ProposalPageFusionInformations />', () => {
  ...
  it('should render a list of proposal merged from other proposal', () => {
    const wrapper = shallow(<ProposalPageFusionInformations proposal={proposalFusionnedMergedIn} />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render a list of proposal of merged in other proposal', () => {
    const wrapper = shallow(<ProposalPageFusionInformations proposal={proposalFusionnedMergedFrom} />)
    expect(wrapper).toMatchSnapshot()
  })
})
