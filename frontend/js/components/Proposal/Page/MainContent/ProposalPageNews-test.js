...
describe('<ProposalPageNews />', () => {
  ...
  it('should render correctly and add news is not allow and  with viewerDidAuthor', () => {
    const proposalCantAddNews = {
      ...proposal,
      isProposalAuthorAllowedToAddNews: false,
    };
    const wrapper = shallow(
      <ProposalPageNews proposal={proposalCantAddNews} goToBlog={jest.fn()} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
  ...
  const proposalViewerDidntAuthor = {
    ...proposal,
    viewerDidAuthor: false,
  };
  it('should render correctly without viewerDidAuthor', () => {
    const wrapper = shallow(
      <ProposalPageNews proposal={proposalViewerDidntAuthor} goToBlog={jest.fn()} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
  const emptyProposalViewerDidntAuthor = {
    ...emptyProposal,
    viewerDidAuthor: false,
  };
  it('should render correctly without news and  without viewerDidAuthor', () => {
    const wrapper = shallow(
      <ProposalPageNews proposal={emptyProposalViewerDidntAuthor} goToBlog={jest.fn()} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
  ...
  it('should render correctly without news and add news is not allow and  without viewerDidAuthor', () => {
    const proposalCantAddNews = {
      ...emptyProposalViewerDidntAuthor,
      isProposalAuthorAllowedToAddNews: false,
    };
    const wrapper = shallow(
      <ProposalPageNews proposal={proposalCantAddNews} goToBlog={jest.fn()} />,
