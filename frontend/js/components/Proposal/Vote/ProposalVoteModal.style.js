...
export const ProposalVoteMultiModalContainer: StyledComponent<
  {},
  {},
  typeof MultiStepModal,
> = styled(MultiStepModal).attrs({
...
export const ProposalVoteModalContainer: StyledComponent<{}, {}, typeof Modal> = styled(
  Modal,
).attrs({
  className: 'proposalVote__modal',
})`
