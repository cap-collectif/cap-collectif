...
const STEP_FRAGMENT = graphql`
  fragment ProposalSmsVoteModal_step on ProposalStep
  {
    id
    votesRanking
    ...interpellationLabelHelper_step @relay(mask: false)
    ...ProposalSmsVoteSuggestionsModal_step
    ...ProposalVoteSmsConfirmationModal_step
  }
`;

export const ProposalSmsVoteModal = ({
  ...
  return (
      <ProposalVoteMultiModalContainer
        ...
        <ProposalVoteSmsConfirmationModal
          ...
          setStatus={setStatus}
        />
        <ProposalSmsVoteSuggestionsModal
          status={status}
          step={step}
          proposal={proposal}
        />
