...
describe('<ProposalVoteModal />', () => {
    ...
    Step: () => ({
      ...
      proposals: {
        pageInfo: {
          hasNextPage: false,
          endCursor:
            'YToyOntpOjA7ZDowLjIxMDA3MzM1O2k6MTtzOjI4OiJwcm9wb3NpdGlvblBvdXJUZXN0TGVEb3VibG9uIjt9',
          hasPreviousPage: false,
          startCursor:
            'YToyOntpOjA7ZDowLjYxMjg0OTgzO2k6MTtzOjI3OiJwcm9wb3NhbEJ5RnJhbmNlQ29ubmVjdFVzZXIiO30=',
        },
        edges: [],
        totalCount: 2,
      },
  ...
  const query = graphql`
    query ProposalVoteModalTestQuery(
      $id: ID = "<default>"
  ...
  beforeEach(() => {
    ...
    TestComponent = props => (
      <RelaySuspensFragmentTest
        useCapUIProvider
        store={{
          proposal: { currentVoteModal: 'proposal1' },
        }}
