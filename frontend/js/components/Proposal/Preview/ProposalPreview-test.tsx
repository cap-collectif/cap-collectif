...
describe('<ProposalPreview />', () => {
  ...
  it('should render a proposal preview', () => {
    const wrapper = shallow(<ProposalPreview proposal={proposal} step={step} features={features} viewer={null} />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render a proposal preview vip', () => {
    const featureProps = { ...features, display_pictures_in_depository_proposals_list: true }
