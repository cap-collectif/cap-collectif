...
describe('<ProposalForm />', () => {
  ...
  const props = {
    ...
    ...formMock,
    responses: [],
    proposalForm: { ...proposalForm, $refType },
    user: {
      id: 'user',
      username: 'user',
    },
  ...
  it('should render a create Question form', () => {
    const questionProps = { ...props, proposalForm: { ...proposalForm, $refType, objectType: 'QUESTION' } }
  ...
  it('should render a create Question form with hidden questions', () => {
    const questionProps = {
      ...props,
      proposalForm: { ...hiddenQuestionsProposalForm, $refType, objectType: 'QUESTION' },
    }
    const wrapper = shallow(<ProposalForm {...questionProps} proposal={null} />)
    expect(wrapper).toMatchSnapshot()
  })
