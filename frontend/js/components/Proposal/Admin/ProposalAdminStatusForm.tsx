...
type FormValues = {
  ...
  trashedReason: string | null | undefined
}
...
const onSubmit = (values: FormValues, dispatch: Dispatch, props: Props) => {
  ...
  return ChangeProposalPublicationStatusMutation.commit({
    ...
    authorEmail: props.proposal.authorEmail,
  })
}
        ...
        <div className="box-header">
          ...
          <a
            ...
            href={intl.formatMessage({
              id: 'admin.help.link.proposal.state',
            })}
          >
        ...
        <div className="box-content box-content__status-form">
          <form onSubmit={handleSubmit}>
            ...
            <Field
              ...
              component={component}
              disabled={!isSuperAdmin && (publicationStatus === 'DELETED' || publicationStatus === 'UNPUBLISHED')}
            >
              {isAuthor && (
                <ToggleButton onClick={() => dispatch(change(formName, 'publicationStatus', 'DRAFT'))} value="DRAFT">
              ...
              {publicationStatus === 'UNPUBLISHED' && (
                <ToggleButton value="UNPUBLISHED">
                  <FormattedMessage id="admin.fields.proposal.state.choices.unpublished" />
                </ToggleButton>
              )}
