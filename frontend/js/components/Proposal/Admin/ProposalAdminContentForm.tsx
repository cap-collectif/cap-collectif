...
import { Field, FieldArray, formValueSelector, reduxForm, SubmissionError, submit } from 'redux-form'
...
import '~/components/Proposal/Admin/ProposalAdminContentCreateForm'
type FormValues = {
  media:
    | {
        id: Uuid
  ...
  theme?: Uuid | null | undefined
  addressText?: string | null | undefined
  category?: Uuid | null | undefined
  district?: Uuid | null | undefined
...
const onSubmit = (values: FormValues, dispatch: Dispatch, { proposal, isAdmin, features }: Props) => {
  const input = {
    title: values.title,
...
export const checkProposalContent = (
  ...
  if (!values.title || values.title.length <= 2) {
    messages.title = isDraft ? 'proposal.constraints.title_for_draft' : 'proposal.constraints.title'
  } else if (values.title.length >= 255) {
    messages.title = 'question.title.max_length'
  }

  if (proposalForm.usingSummary && values.summary && (values.summary.length > 140 || values.summary.length < 2)) {
    messages.summary = 'proposal.constraints.summary'
  }

  if (proposalForm.usingDescription && proposalForm.descriptionMandatory && (!values.body || values.body.length <= 2)) {
...
export const validateProposalContent = (
  ...
  const errors: any = !isDraft ? checkProposalContent(values, proposalForm, features, intl, isDraft) : {}
  ...
  if (proposalForm.usingSummary && values.summary && (values.summary.length > 140 || values.summary.length < 2)) {
    errors.summary = values.summary.length > 140 ? 'proposal.constraints.summary' : 'proposal.constraints.min.summary'
  }
...
export const warnProposalContent = (
  ...
  const responsesWarning = warnResponses(proposalForm.questions, values.responses, 'proposal', intl)
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="box-header">
              ...
              <a
                ...
                href={intl.formatMessage({
                  id: 'admin.help.link.proposal.body',
                })}
              >
          ...
          {proposal.form.isUsingAnySocialNetworks && (
            <ExternaLinksCard paddingY={8} mt={6} backgroundColor={styleGuideColors.white}>
              <Heading as="h3" color={styleGuideColors.blue800} fontWeight="600" fontSize="18px" lineHeight="24px">
            ...
            <NotationCard backgroundColor="white" flex="1" px={24}>
              <Flex spacing="9px">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  href={intl.formatMessage({
                    id: 'admin.help.link.proposal.estimation',
                  })}
                >
              ...
              >
                ...
                >
                  ...
                  (proposal.form.analysisConfiguration?.costEstimationEnabled &&
                    ...
                    <AppBox mt="16px" color={styleGuideColors.blue500} fontWeight="bold" fontSize="11px">
            ...
            <NotationCard backgroundColor="white" flex="1" px={24}>
              <Flex spacing="9px">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  href={intl.formatMessage({
                    id: 'admin.help.link.proposal.heart',
                  })}
                >
                  <Icon name={ICON_NAME.information} size={14} color={colors.blue} />
                </a>
      ...
      theme:
        state.default.features.themes && proposal.form.usingThemes
          ? proposal.theme
            ...
            : null
          : undefined,
      category: proposal.form.usingCategories ? (proposal.category ? proposal.category.id : null) : undefined,
      district:
        state.default.features.districts && proposal.form.usingDistrict
          ? proposal.district
            ...
            : null
          : undefined,
      address: proposal.form.usingAddress && proposal.address?.json ? proposal.address.json : undefined,
