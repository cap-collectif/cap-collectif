...
describe('<UpdateReplyModal />', () => {
  ...
  it('should render correctly with minimal null value', () => {
    const wrapper = shallow(<ResponseValue {...defaultProps} response={{ ...defaultProps.response, value: null }} />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render correctly with question type editor', () => {
    ...
    const wrapper = shallow(
      <ResponseValue {...defaultProps} response={{ ...defaultProps.response, question: editorType.question }} />,
    )
    expect(wrapper).toMatchSnapshot()
  })
