...
export const QuestionnaireContainer: StyledComponent<{}, {}, HTMLFormElement> = styled.form`
  position: relative;
...
export const WrapperWithMarge: StyledComponent<{}, {}, HTMLDivElement> = styled(AppBox)`
  padding: 32px;
`;

export const WrapperWithMargeX: StyledComponent<{}, {}, HTMLDivElement> = styled(AppBox)`
  padding-left: 32px;
  padding-right: 32px;
`;

export const ButtonGroupSubmit: StyledComponent<{}, {}, HTMLDivElement> = styled.div`
  margin-top: 22px;
