...
import type { DraftContentBlock, IframeEntityData } from '../models/types'
import '../models/types'
...
function IframeToolbar({ block, entityData, children, intl }: IframeToolbarProps) {
  ...
  const iframePopover = usePopoverState({
    placement: 'top',
  })
  ...
  return (
    <>
      <IframePropertiesDialog mode="edit" onConfirm={handleEdit} initialData={entityData} {...editIframeDialog} />
      <MediaWrapper>
