...
const getBlockRendererFn = (editor: Record<string, any>) => (contentBlock: Record<string, any>) => {
...
function blockStyleFn(block: Record<string, any>): string {
...
function keyBindingFn(event: React.KeyboardEvent): string | null | undefined {
  // Insert link : CMD + K
...
export default {
  ...
  customStyleMap: { ...colorStyleMap, ...bgStyleMap },
}
