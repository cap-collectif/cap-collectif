...
import type { DraftEditorState, DraftContentBlock, DraftEntity, DraftEntityType } from './models/types'
...
export function getActiveColor(editorState: DraftEditorState, type: string): string | null | undefined {
...
export function insertAtomicBlock(
  ...
  entityData: Record<string, any> | null | undefined,
): DraftEditorState {
 ...
 */
export function getSelectedBlocksMap(editorState: typeof EditorState): Record<string, any> {
 ...
 * Function returns collection of currently selected blocks.
 */
export function getSelectedBlocksList(editorState: DraftEditorState): Record<string, any> {
 ...
 */
export function getSelectedBlock(editorState: DraftEditorState): DraftContentBlock | null | undefined {
  if (editorState) {
...
export function getSelectionEntity(editorState: DraftEditorState): DraftEntity | null | undefined {
  let entity
