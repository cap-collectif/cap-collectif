// @flow
import React, { useEffect, useRef, useState, type Node, type ComponentType } from 'react';
import styled, { css } from 'styled-components';

import { useDialogState, type DialogState } from './Dialog';
...
const defaultPopoverState = { gutter: 10, placement: 'top' };

export function usePopoverState(
  initialState: $Shape<PopoverState> = defaultPopoverState,
): PopoverState {
