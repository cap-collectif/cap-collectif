        ...
        <div className="media-body">
          ...
          <p className="excerpt  media--news__meta">
            ...
            <FormattedMessage
              id="global.byDate"
              values={{
                date: <FormattedDate value={moment(post.publishedAt)} day="numeric" month="long" year="numeric" />,
              }}
            />{' '}
                  ...
                  author: (
                    <span>
                      {post.authors.map((author, i) => (
                        <span key={i}>
                          {features.profiles ? <a href={author.url}>{author.displayName}</a> : author.displayName}
