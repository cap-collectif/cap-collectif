    ...
    <React.Fragment>
      ...
      {hasParticipativeStep && (
        <div className="mb-30 project__step__consultation--counters text-center">
          <div className="mr-15 d-ib">
            <i className="cap cap-baloon-1" /> {step.contributions && step.contributions.totalCount}{' '}
            <FormattedMessage
              id="project.preview.counters.contributions"
              values={{
                num: step.contributions && step.contributions.totalCount,
              }}
            />
          </div>
          <div className="mr-15 d-ib">
          ...
          <div className="mr-15 d-ib">
            ...
            <FormattedMessage
              ...
              values={{
                num: step.contributors.totalCount,
              }}
            />
          </div>
        </div>
...
export default createFragmentContainer(ConsultationStepHeader, {
  step: graphql`
    fragment ConsultationStepHeader_step on ConsultationStep @argumentDefinitions(exceptStepId: { type: "ID" }) {
      project {
