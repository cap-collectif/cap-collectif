  ...
  const defaultProps = {
    vote: {
      ...
      author: {
        ...
        vip: false,
        media: {
          url: 'https://capco.dev/media/default/0001/01/32618f20c0942f89316be7f88d1bfa3489e2dcef.jpeg',
        },
      },
      related: {
        id: 'version2',
        url: 'https://capco.dev/projects/projet-de-loi-renseignement/consultation/elaboration-de-la-loi/opinions/titre-ier-la-circulation-des-donnees-et-du-savoir/chapitre-ier-economie-de-la-donnee/section-1-ouverture-des-donnees-publiques/article-1/versions/modification-2',
        title: 'Modification 2',
      },
    },
  }
  const voteAgainstProps = { ...defaultProps, vote: { ...defaultProps.vote, value: 'NO' } }
  const voteMitigatedProps = { ...defaultProps, vote: { ...defaultProps.vote, value: 'MITIGE' } }
