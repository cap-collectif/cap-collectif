...
const ModalDNSRegistration = ({ dkim }: Props): React.Node => {
  const intl = useIntl();
  ...
  return (
    <Flex direction="column" spacing={6} color="gray.900">
      <Flex direction="column" spacing={1}>
        ...
        <Flex direction="column" spacing={1}>
          <Text>{intl.formatMessage({ id: 'global.value' })}</Text>
          <Flex
            direction="row"
      ...
      <Flex direction="column" spacing={1}>
        ...
        <Flex direction="row" justify="space-between" spacing={6}>
          <Flex direction="column" spacing={1} width="50%">
            <Text>{intl.formatMessage({ id: 'sub-domain' })}</Text>
            <Flex
              direction="row"
              justify="space-between"
              px={3}
          ...
          <Flex direction="column" spacing={1} width="50%">
            ...
            <Flex
              ...
              borderColor="gray.300"
              borderRadius="normal">
              <Text overflow="hidden" css={{ textOverflow: 'ellipsis', whiteSpace: 'pre' }}>
                {dkim.value}
              </Text>
