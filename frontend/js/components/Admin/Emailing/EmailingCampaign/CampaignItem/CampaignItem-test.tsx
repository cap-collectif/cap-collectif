...
const props = {
  ...
  noMailingList: { ...baseProps, campaign: { ...baseProps.campaign, mailingList: null } },
  noSendAt: { ...baseProps, campaign: { ...baseProps.campaign, sendAt: null } },
  withMailingInternal: {
    ...baseProps,
    campaign: { ...baseProps.campaign, mailingInternal: 'REGISTERED' as any, mailingList: null },
  },
  withGroup: {
    ...baseProps,
    campaign: {
