...
export const ContentPage = ({ disabled, showError, emailingCampaign }: Props) => {
  ...
  const previewMailRef = React.useRef<HTMLDivElement | null | undefined>(null)
  return (
    <Container disabled={disabled}>
      ...
      <PreviewContainer>
        ...
        <button
          ...
          disabled={disabled}
          onClick={() =>
            previewMailRef?.current?.scrollIntoView({
              behavior: 'smooth',
              block: 'center',
            })
          }
      ...
      {isOpen && <ModalMailTest show={isOpen} onClose={onClose} emailingCampaign={emailingCampaign} />}
    </Container>
  )
}
