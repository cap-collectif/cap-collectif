...
const listMailingList = ({
  ...
  props: EmailingListPageQueryResponse | null | undefined
}) => {
  const viewer = props?.viewer
  const organization = viewer?.organizations?.[0]
  return (
    <Skeleton isLoaded={!!props} placeholder={<DashboardMailingListPlaceholder hasError={!!error} fetchData={retry} />}>
