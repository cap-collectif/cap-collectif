...
type Props = {
  readonly mailingList: Members_mailingList
...
export default createPaginationContainer(
  ...
  },
  {
    ...
    getVariables(props: Props, { count, cursor }, fragmentVariables) {
      return { ...fragmentVariables, count, cursor, isAdmin: props.isAdmin, mailingListId: props.mailingList.id }
    },

    query: graphql`
      query MembersPaginatedQuery($mailingListId: ID!, $count: Int!, $cursor: String, $isAdmin: Boolean!) {
