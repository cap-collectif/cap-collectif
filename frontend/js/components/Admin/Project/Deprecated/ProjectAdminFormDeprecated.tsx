...
import '~relay/ProjectAdminFormDeprecated_project.graphql'
...
type Props = ReduxFormFormProps & {
  project: ProjectAdminFormDeprecated_project | null | undefined
  intl: IntlShape
  formName: string
  isAdmin: boolean
}
...
const onSubmit = ({ title, authors, projectType }: FormValues, dispatch: Dispatch, props: Props) => {
  const input = {
    title,
    projectType,
