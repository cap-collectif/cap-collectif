...
export const renderLabel = (
  ...
  <Flex direction="row" wrap="nowrap">
    ...
    <Flex as="span" direction="row" wrap="nowrap" align="center" color="gray.500" fontWeight="normal" marginLeft={1}>
      {optional
        ? intl.formatMessage({
            id: 'global.optional',
          })
    ...
    <div className="col-md-12">
      <ProjectBoxContainer className="box container-fluid">
        ...
        <div className="box-content">
          <Field type="text" name="title" label={<FormattedMessage id="global.title" />} component={renderComponent} />
          {isAdmin && (
            <UserListField
              id="project-author"
              name="authors"
