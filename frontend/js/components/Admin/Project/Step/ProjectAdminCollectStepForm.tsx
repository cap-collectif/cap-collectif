...
export const getAvailableProposals = graphql`
  query ProjectAdminCollectStepFormProposalsQuery($term: String, $affiliations: [ProposalFormAffiliation!]) {
    viewer {
...
export const loadProposalOptions = (
  ...
  return fetchQuery_DEPRECATED(environment, getAvailableProposals, {
    ...
    const proposalsForms = data.viewer.organizations?.[0]?.proposalForms ?? data.viewer.proposalForms
