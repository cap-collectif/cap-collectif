...
const CustomOptionItem: StyledComponent<{}, {}, typeof Menu.OptionItem> = styled(Menu.OptionItem)`
  input {
    display: none;
  }
`;
        ...
        <Menu.OptionGroup
          ...
          title={
            <Flex direction="row" justify="space-between">
              {intl.formatMessage({ id: 'pop.over.label.export.data-set' })}
            ...
            <CustomOptionItem key={step.id} value={step.slug} fontSize={12} className="excerpt">
              <Text>
                <strong className="bold-content">
                  {intl.formatMessage({ id: 'admin.label.step' })}
