...
export const ArgumentTab = ({ debate, relay }: Props) => {
  ...
  return hasArguments ? (
      ...
      {debateArguments.totalCount > 0 ? (
        <AppBox
          ...
          css={{
            listStyle: 'none',
            overflow: 'auto',
            maxHeight: `${MAX_HEIGHT_8_ARGUMENTS}px`,
          }}
          ref={listArgumentRef}
        >
          <InfiniteScroll
        ...
        <ModalModerateArgument
          ...
          relayConnection={[
            formatConnectionPath(
              ...
              `(isPublished:${(moderateArgumentModal.state === 'PUBLISHED').toString()},isTrashed:false)`,
            ),
          ]}
        />
      )}
    ...
    <Flex direction="column" spacing={6} align="center">
      ...
      <Text color="gray.500">
        {intl.formatMessage({
          id: 'debate.empty.arguments.section',
        })}
      </Text>
    </Flex>
  )
...
export default createPaginationContainer(
    ...
    debate: graphql`
      ...
      @argumentDefinitions(
        ...
        debateArguments: arguments(
          ...
          isTrashed: $isTrashed
        ) @connection(key: "ArgumentTab_debateArguments", filters: ["value", "isPublished", "isTrashed"]) {
          totalCount
          pageInfo {
            hasNextPage
          }
  ...
  },
  {
    ...
    getVariables(props: Props, { count, cursor }, fragmentVariables) {
      return { ...fragmentVariables, count, cursor, debateId: props.debate.id }
    },
