  ...
  return (
    <Container animation={false} show={show} onHide={onClose} bsSize="large" aria-labelledby="modal-title">
      ...
      <Modal.Footer>
        <ButtonSave
          type="button"
          onClick={() => createMailingList(project.id, members, mailingListName, onClose, organization?.id)}
          disabled={pristine}
        >
...
const ModalCreateMailingListConnected = connect<any, any>(mapStateToProps)(form)
