...
describe('<ProjectItem />', () => {
  ...
  const defaultMockResolvers = {
    Project: () => ({
      ...
      url:
        'https://capco.dev/project/strategie-technologique-de-letat-et-services-publics/consultation/collecte-des-avis-pour-une-meilleur-strategie',
      adminUrl:
      ...
      exportContributorsUrl: 'https://capco.dev/export-project-contributors/project2?_locale=fr-FR',
      exportableSteps: [
        {
          position: 1,
          step: {
