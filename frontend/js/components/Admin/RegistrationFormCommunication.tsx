...
const onSubmit = (values: FormValues, dispatch: Dispatch, props: Props) => {
  ...
  const input = {
    translations: handleTranslationChange(
      props.registrationForm && props.registrationForm.translations ? props.registrationForm.translations : [],
      translation,
  ...
  return UpdateRegistrationFormCommunicationMutation.commit({
    input,
  })
    .then(response => {
  ...
  <div className="box box-primary container-fluid">
    <div className="box-content box-content__content-form">
      <form onSubmit={handleSubmit}>
        ...
        <Field type="checkbox" name="topTextDisplayed" component={renderInput} id="display-message-above-form">
          <FormattedMessage id="registration.admin.topText" />
        </Field>
        {useTopText && <Field name="topText" type="admin-editor" formName={formName} component={renderInput} />}
        <Field type="checkbox" name="bottomTextDisplayed" component={renderInput} id="display-message-below-form">
          <FormattedMessage id="registration.admin.bottomText" />
        </Field>
        {useBottomText && <Field name="bottomText" type="admin-editor" formName={formName} component={renderInput} />}
        <div className="box-content__toolbar btn-toolbar">
          ...
          <AlertForm submitting={submitting} submitSucceeded={submitSucceeded} submitFailed={submitFailed} />
        </div>
      </form>
    </div>
  </div>
