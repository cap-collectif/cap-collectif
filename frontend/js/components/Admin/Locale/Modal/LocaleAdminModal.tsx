...
export const LocaleAdminModal = ({ locales, displayModal, show, dispatch, pristine, invalid, submitting }: Props) => {
  if (locales) {
    return (
        ...
        <form id={`${formName}`} onSubmit={onSubmit}>
          <Modal.Header closeButton>
            <Modal.Title className="font-weight-bold">
              <Icon name={ICON_NAME.networkAdd} size={32} /> <FormattedMessage id="add-a-language" />
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
