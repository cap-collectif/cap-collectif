...
export const Sidebar = ({ appVersion, defaultAccordeon, designSystem }: Props): JSX.Element => {
  ...
  React.useEffect(() => {
    ...
    setIsFirstRender(false) // we only want this on our first render
  ...
  return (
    ...
    >
      ...
      >
        <Flex boxShadow="0px 4px 13px rgb(0 0 0 / 20%);" p={4} justifyContent="space-between" position="relative">
          <a
            href="/"
            style={{
              overflow: 'hidden',
            ...
            {isAdmin ? (
              <SidebarAccordionItem id="contributions">
                ...
                <SidebarAccordionPanel isOpen={isOpen} isFirstRender={isFirstRender}>
                  {features.reporting && <SidebarLink text="admin.label.reporting" href="/admin/reporting" />}
                  ...
                  <SidebarLink text="admin.label.opinion_version" href="/admin/capco/app/opinionversion/list" />
            ...
            {isAdmin ? (
              <SidebarAccordionItem id="reglages">
                ...
                <SidebarAccordionPanel isOpen={isOpen} isFirstRender={isFirstRender}>
                  ...
                  {features.hub_api_green && isSuperAdmin ? (
                    <SidebarLink text="admin.hub-api-green" href="/admin-next/hub-api-green" />
                  ) : null}
        ...
        {isOpen && (
          <Text as="span" color="gray.700" position="absolute" bottom={5} fontSize={11} textAlign="center" width="100%">
            {`${intl.formatMessage({
              id: 'app-version',
            })} ${appVersion}`}
          </Text>
