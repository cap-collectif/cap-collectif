...
export const SidebarButton = ({ children, icon, text, isOpen, ...props }: Props): JSX.Element => {
  ...
  return (
    <Button
      ...
      css={{
        '&:hover': {
          color: colors.gray[open ? 100 : 300],
        },
      }}
      {...props}
    >
      ...
      {isOpen && <Icon name={open ? ICON_NAME.ARROW_UP : ICON_NAME.ARROW_DOWN} size={ICON_SIZE.SM} marginLeft={1} />}
    </Button>
  )
}
