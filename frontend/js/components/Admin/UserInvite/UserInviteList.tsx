...
import { CONNECTION_NODES_PER_PAGE, FRAGMENT } from '~/components/Admin/UserInvite/UserInviteList.relay'
...
export const UserInviteList = ({ query: queryFragment, status, setStatus, term }: Props): JSX.Element => {
  const intl = useIntl()
              ...
              {({ styles }) => (
                <Menu>
                  ...
                  <Menu.List>
                    <Menu.OptionGroup
                      value={status}
                      onChange={value => setStatus(value as any as string)}
                      type="radio"
