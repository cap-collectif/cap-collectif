...
const renderQuestions = ({
  ...
  props: RegistrationAdminPageQueryResponse | null | undefined
}) => {
  if (error) {
...
`
export const RegistrationAdminPage = ({ isSuperAdmin, onToggle, features, query }: Props) => (
  <>
    <QueryRenderer
      ...
      <div className="box-content box-content__content-form">
        ...
        <div className="d-flex align-items-baseline mb-15 mt-15">
          <Toggle
            ...
            onChange={() =>
              onToggle('restrict_registration_via_email_domain', !features.restrict_registration_via_email_domain)
            }
    ...
    <div className="box box-primary container-fluid">
      <div className="box-content box-content__content-form">
        ...
        <div className="d-flex align-items-baseline mb-15 mt-15">
          <Toggle id="toggle-fullname" checked disabled label={<FormattedMessage id="global.fullname" />} />
        </div>
        <div className="d-flex align-items-baseline mb-15 mt-15">
          <Toggle id="toggle-password" checked disabled label={<FormattedMessage id="registration.password" />} />
        </div>
        <div className="d-flex align-items-baseline mb-15 mt-15">
          <Toggle
            id="toggle-zipcode"
      ...
      <div className="box-content box-content__content-form">
        ...
        <div className="d-flex align-items-baseline mb-15 mt-15">
          <Toggle
            ...
            onChange={() => onToggle('consent_internal_communication', !features.consent_internal_communication)}
            label={
              <span>
                <strong>
        ...
        <div className="d-flex align-items-baseline mb-15 mt-15">
          <Toggle
            ...
            onChange={() => onToggle('consent_external_communication', !features.consent_external_communication)}
            label={
              <span>
                <strong>
