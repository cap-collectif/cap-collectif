...
export const Thumbnail = styled.img<{
  ...
  width: ${props => (props.size === UPLOADER_SIZE.SM && !!props.circle ? 'calc(100% - 16px);' : 'calc(100% - 32px)')};
  height: ${props => (props.size === UPLOADER_SIZE.SM && !!props.circle ? 'calc(100% - 16px);' : 'calc(100% - 32px)')};
