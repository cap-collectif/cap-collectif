...
type CoverImageProps = AppBoxProps & {
  src: string
  alt: string
  isArchived: boolean
}
...
type CoverVideoProps = AppBoxProps & {
  src?: string
  alt?: string
  readonly url: string
...
type AuthorsProps = AvatarGroupProps & {
  active: boolean
  children: JSX.Element | JSX.Element[] | string
}
...
type LocationProps = AppBoxProps & {
