...
describe('<ProjectCard />', () => {
  const project = {
    ...
    publishedAt: '2021-03-04 22:00:00',
    isExternal: false,
    externalLink: null,
  ...
  const projectWithoutParticipativeStep = {
    ...project,
  ...
  const projectWithThemesAndDistricts = {
    ...project,
    themes: [{ title: 'Politique' }, { title: 'Education' }],
    districts: {
      totalCount: 2,
      edges: [{ node: { name: 'Paris' } }, { node: { name: 'Perpignan' } }],
    },
  };
  ...
  it('should render correctly', () => {
    const wrapper = shallow(
      <ProjectCard backgroundColor="#e5e5e5" isProjectsPage={false} project={project} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
  it('should render correctly on project page', () => {
    const wrapper = shallow(
      <ProjectCard backgroundColor="#e5e5e5" isProjectsPage project={project} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
  ...
  it('should render correctly without cover', () => {
    const wrapper = shallow(
      <ProjectCard backgroundColor="#e5e5e5" isProjectsPage project={projectWithoutCover} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
