...
describe('<MultipleRadio />', () => {
  it('should render correctly', () => {
    const wrapper = shallow(<MultipleRadio {...props.basic} />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render correctly when disabled', () => {
    const wrapper = shallow(<MultipleRadio {...props.disabled} />)
    expect(wrapper).toMatchSnapshot()
  })
  it('should render correctly when in questionnaire form', () => {
    const wrapper = shallow(<MultipleRadio {...props.inQuestionnaire} />)
    expect(wrapper).toMatchSnapshot()
  })
})
