...
const rankingLabel = {
  basic: { ...baseRankingLabel },
  withoutDescription: { ...baseRankingLabel, description: null },
  withoutImage: { ...baseRankingLabel, image: null },
  disabled: { ...baseRankingLabel, isDisabled: true },
}
