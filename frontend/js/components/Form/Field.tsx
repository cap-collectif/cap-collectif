...
import type { DateTimeInputProps, TimeConstraintsProps, DateProps } from '~/components/Form/DateTime'
...
const canCheckValidation = (check, typeForm, disableValidation) =>
  (check && !disableValidation && !isQuestionnaire(typeForm)) || (!disableValidation && isQuestionnaire(typeForm))
  ...
  render() {
    ...
    const component = (
      <Input
        ...
        validationState={canCheckValidation(check, typeForm, disableValidation) ? (error ? 'error' : 'success') : null}
