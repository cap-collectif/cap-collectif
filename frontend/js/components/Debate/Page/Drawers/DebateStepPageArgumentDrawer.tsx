...
type Props = {
  ...
  readonly argument: DebateStepPageArgumentDrawer_argument$key
  readonly viewer: DebateStepPageArgumentDrawer_viewer$key | null | undefined
}
      ...
      >
        <LoginOverlay enabled={!stepClosed} placement="bottom">
          <Button
            ...
            onClick={() =>
              voteForArgument(argument.id, argument.viewerHasVote, intl, argument.votes.totalCount, widget.location)
            }
            aria-label={intl.formatMessage({
