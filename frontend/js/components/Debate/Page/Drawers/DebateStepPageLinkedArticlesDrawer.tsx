...
type Props = {
  ...
  readonly step: DebateStepPageLinkedArticlesDrawer_step
}

const DebateStepPageLinkedArticlesDrawer = ({ step, ...drawerProps }: Props): JSX.Element => {
  const articles =
...
export default createFragmentContainer(DebateStepPageLinkedArticlesDrawer, {
  ...
  `,
}) as RelayFragmentContainer<typeof DebateStepPageLinkedArticlesDrawer>
