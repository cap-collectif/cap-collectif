...
type Props = {
  ...
  readonly opinion: DebateStepPageOpinionDrawer_opinion$key
}

const DebateStepPageOpinionDrawer = ({ opinion: opinionFragment, ...drawerProps }: Props): JSX.Element => {
    ...
    <DetailDrawer {...drawerProps}>
      <DetailDrawer.Body position="relative">
        ...
        <Flex direction="column" mt={6} align="center">
          ...
          <Tag mt={1} variantColor={opinion.type === 'FOR' ? 'success' : 'danger'}>
