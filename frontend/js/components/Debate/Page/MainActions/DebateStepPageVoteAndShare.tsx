...
import type { VoteState } from './DebateStepPageStateMachine'
import { debateStateMachine, getInitialState, MachineContext } from './DebateStepPageStateMachine'
type Props = {
  readonly step: DebateStepPageVoteAndShare_step
...
export const DebateStepPageVoteAndShare = ({ isMobile, step }: Props): Node => {
  ...
  useEffect(() => {
    send(
      getInitialState(debate, stepClosed, viewerIsConfirmedByEmail, isAnonymousParticipationAllowed, isAuthenticated),
...
export default createFragmentContainer(DebateStepPageVoteAndShare, {
  ...
  `,
}) as RelayFragmentContainer<typeof DebateStepPageVoteAndShare>
