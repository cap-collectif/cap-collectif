...
type Props = {
  readonly step: DebateStepPageNotYetStarted_step | null | undefined
}
export const DebateStepPageNotYetStarted = ({ step }: Props): JSX.Element => {
...
export default createFragmentContainer(DebateStepPageNotYetStarted, {
  ...
  `,
}) as RelayFragmentContainer<typeof DebateStepPageNotYetStarted>
