...
import { Button, Modal, Heading, Text, CapUIIcon, CapUIModalSize, ButtonQuickAction } from '@cap-collectif/ui'
...
export const ModalModerateArgumentMobile = ({ argument }: Props): JSX.Element => {
  const intl = useIntl()
            ...
            <Modal.Body pb={6}>
              <ModerateForm
                onSubmit={(values: Values) => {
                  ...
                  trashAlternateArgument(argument, values, setModalState, setErrorCount, errorCount)
                }}
              />
            </Modal.Body>
            ...
            <Modal.Footer justify="center">
              {errorCount <= 1 ? (
                <Button
                  ...
                  onClick={() => {
                    if (valuesSaved)
                      trashAlternateArgument(argument, valuesSaved, setModalState, setErrorCount, errorCount)
                  }}
                >
                  {intl.formatMessage({
...
export default createFragmentContainer(ModalModerateArgumentMobile, {
  ...
  `,
}) as RelayFragmentContainer<typeof ModalModerateArgumentMobile>
