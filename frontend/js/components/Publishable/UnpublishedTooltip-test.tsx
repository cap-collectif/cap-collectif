...
describe('<UnpublishedTooltip />', () => {
  it('renders when published', () => {
    ...
    const wrapper = shallow(<UnpublishedTooltip publishable={publishablePublished} target={jest.fn()} />)
  ...
  it('renders when not published because author must confirm', () => {
    ...
    const wrapper = shallow(<UnpublishedTooltip publishable={publishableUnublishedWaiting} target={jest.fn()} />)
    expect(wrapper).toMatchSnapshot()
  })
  it('renders when not published because author is not confirmed', () => {
    ...
    const wrapper = shallow(<UnpublishedTooltip publishable={publishableUnublishedNotConfirmed} target={jest.fn()} />)
    expect(wrapper).toMatchSnapshot()
  })
  it('renders when not published because author confirmed his account too late', () => {
    ...
    const wrapper = shallow(<UnpublishedTooltip publishable={publishableUnublishedTooLate} target={jest.fn()} />)
    expect(wrapper).toMatchSnapshot()
  })
})
