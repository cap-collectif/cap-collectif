...
const PanelBorderStyle = ({ member, isPanelOpen, handlePanelToggle, dispatch, opacity, formName }: Props) => (
    ...
    <Panel.Collapse>
      <PanelBody>
        <Field
          ...
          id="color"
          opacity={opacity}
          getOpacity={colorOpacity => dispatch(change(formName, `${member}.border.opacity`, colorOpacity))}
          placeholder="#000000"
...
export default withPanelStyle(connect<any, any>(mapStateToProps)(PanelBorderStyle))
