...
const AccessDenied = (): JSX.Element => {
  ...
  return (
    <Flex direction="column" justifyContent="flex-start" alignItems="center" bg="white" pb="100px" pt="100px">
      <Text fontSize={5} fontWeight={600} mb={2}>
        {intl.formatMessage({
          id: 'unauthorized-access',
        })}
      </Text>
      <Text fontSize={4} mb="41px" textAlign="center">
        {intl.formatMessage({
      ...
      <Link href={`${baseUrl}/contact`} fontSize={3}>
        {intl.formatMessage({
          id: 'error.report',
        })}
      </Link>
