...
const ProposalAdminPage = lazy(
  () =>
    import(
      /* webpackChunkName: "ProposalAdminPage" */ '~/components/Proposal/Admin/ProposalAdminPage'
    ),
);
const ProposalAdminCreatePage = lazy(
  () =>
    import(
      /* webpackChunkName: "ProposalAdminCreatePage" */ '~/components/Proposal/Admin/ProposalAdminCreatePage'
    ),
);
