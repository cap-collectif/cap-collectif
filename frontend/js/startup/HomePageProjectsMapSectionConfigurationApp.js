    ...
    <RelayEnvironmentProvider environment={environment}>
      <QueryRenderer
        ...
        render={({
          ...
          props: ?HomePageProjectsMapSectionConfigurationAppQueryResponse,
        }) => {
          if (error) {
            return graphqlError;
          }
          if (props && props?.homePageProjectsMapSectionConfiguration) {
            return (
              <HomePageProjectsMapSectionConfigurationPage
                {...props}
                homePageProjectsMapSectionConfigurationFragmentRef={
                  props?.homePageProjectsMapSectionConfiguration
                }
