...
const VoteListProfile = lazy(
  () =>
    import(
      /* webpackChunkName: "VoteListProfile" */
      '~/components/Vote/VoteListProfile'
    ),
)
const DebateVoteListProfile = lazy(
  () =>
    import(
      /* webpackChunkName: "DebateVoteListProfile" */
      '~/components/Vote/DebateVoteListProfile'
    ),
)
    ...
    <Providers designSystem>
      <QueryRenderer
        ...
        render={({
          ...
          props: VoteListAppQueryResponse | null | undefined
        }) => {
          if (error) {
            return graphqlError
          }
