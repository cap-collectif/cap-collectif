...
import '~relay/ProposalCreateFusionButtonAppQuery.graphql'
import Loader from '~ui/FeedbacksIndicators/Loader'

const ProposalCreateFusionButton = lazy(
  () =>
    import(
      /* webpackChunkName: "ProposalCreateFusionButton" */
      '~/components/Proposal/Create/ProposalCreateFusionButton'
    ),
)
    ...
    <Providers>
      <QueryRenderer
        ...
        render={({
          ...
          props: ProposalCreateFusionButtonAppQueryResponse | null | undefined
        }) => {
          if (error) {
            return graphqlError
          }
