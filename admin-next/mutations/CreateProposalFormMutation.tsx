...
import type {
  ...
  CreateProposalFormMutation$data,
  CreateProposalFormMutation$variables,
...
const mutation = graphql`
  mutation CreateProposalFormMutation($input: CreateProposalFormInput!, $connections: [ID!]!) @raw_response_type {
...
const commit = (
  variables: CreateProposalFormMutation$variables,
  isAdmin: boolean,
  owner: Owner,
  viewer: Viewer,
  hasProposalForm: boolean,
): Promise<CreateProposalFormMutation$data> =>
