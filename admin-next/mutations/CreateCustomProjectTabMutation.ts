...
const commit = (
  variables: CreateCustomProjectTabMutation$variables,
  config?: Partial<MutationConfig<CreateCustomProjectTabMutation>>,
): Promise<CreateCustomProjectTabMutation$data> =>
