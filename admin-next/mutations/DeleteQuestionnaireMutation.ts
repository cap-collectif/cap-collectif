...
import type {
  ...
  DeleteQuestionnaireMutation$variables,
} from '@relay/DeleteQuestionnaireMutation.graphql'
import { QuestionnaireType } from '@relay/QuestionnaireListQuery.graphql'

const mutation = graphql`
  mutation DeleteQuestionnaireMutation($input: DeleteQuestionnaireInput!, $connections: [ID!]!) @raw_response_type {
...
const commit = (
  variables: DeleteQuestionnaireMutation$variables,
  isAdmin: boolean,
  types?: Array<QuestionnaireType>,
): Promise<DeleteQuestionnaireMutation$data> =>
