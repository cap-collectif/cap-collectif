import { Box, Button, CapUIFontSize, CapUIFontWeight, CapUIIcon, CircularStep, Icon, Tooltip } from '@cap-collectif/ui'
import { pxToRem } from '@shared/utils/pxToRem'
import { FC } from 'react'
import { useIntl } from 'react-intl'
import { graphql, useFragment } from 'react-relay'
import { ProposalStepUserVotesInfos_proposalStep$key } from '@relay/ProposalStepUserVotesInfos_proposalStep.graphql'
...
interface Props {
  step: ProposalStepUserVotesInfos_proposalStep$key
}

const FRAGMENT = graphql`
  fragment ProposalStepUserVotesInfos_proposalStep on ProposalStep {
    voteType
    budget
    votesLimit
    votesMin
...
const ProposalStepUserVotesInfos: FC<Props> = ({ step: stepKey }) => {
  ...
  return (
    ...
    >
      ...
      <Box color="text.primary" fontSize={CapUIFontSize.BodyLarge} flex="1">
        ...
        <Button variantSize="small" variant="tertiary" marginTop="xxs" paddingLeft="0" rightIcon={CapUIIcon.ArrowDownO}>
...
export default ProposalStepUserVotesInfos
