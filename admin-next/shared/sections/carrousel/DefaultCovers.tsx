...
export const DefaultPostCover = () => (
  <Box as="svg" viewBox="-146.5 -110.5 335.5 301.5" width={pxToRem(130)} height={pxToRem(130)}>
    <line
      fill="none"
      stroke="#FFFFFF"
      strokeWidth="10"
...
export const DefaultThemeCover = () => (
  <Box
    as="svg"
    viewBox="0 0 512 512"
    enable-background="new -162.5 -162.5 226.5 226.5"
    width={pxToRem(130)}
    height={pxToRem(130)}
  >
    <g>
      <polygon
        ...
        strokeLinejoin="round"
        strokeMiterlimit="10"
        points="510,322.58 322.58,510 2,185.931 2,2 185.931,2 	"
      ></polygon>
      <path
        fill="none"
        stroke="#FFFFFF"
        ...
        strokeLinejoin="round"
        strokeMiterlimit="10"
        d="M156.61,112.433 c0,24.393-19.785,44.178-44.178,44.178c-24.386,0-44.17-19.785-44.17-44.178c0-24.403,19.784-44.17,44.17-44.17 C136.826,68.263,156.61,88.029,156.61,112.433z"
      ></path>
    </g>
  </Box>
)

export const DefaultProjectCover = () => <DefaultProjectImage position="relative" top={0} left={0} />
