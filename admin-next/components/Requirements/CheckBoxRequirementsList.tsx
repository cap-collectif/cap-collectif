...
import CheckBoxRequirementItem from "@components/Requirements/CheckBoxRequirementItem";
            ...
            <Flex direction="column" spacing={4}>
                {
                    checkBoxRequirements
                        .map((checkBoxRequirement, index) => {
                            return (checkBoxRequirement.typename === 'CHECKBOX') ? (
                                <CheckBoxRequirementItem key={checkBoxRequirement.id}
