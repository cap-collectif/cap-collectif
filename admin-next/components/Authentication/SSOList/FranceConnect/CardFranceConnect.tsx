...
const CardFranceConnect: FC<CardFranceConnectProps> = ({
  ssoConfiguration: ssoConfigurationFragment,
  organizationName: organizationNameFragment,
  ssoConnectionName,
}) => {
  const intl = useIntl()
          ...
          {hasFranceConnect ? (
            ssoConfiguration ? (
              ...
              <Button
                ...
                variant="tertiary"
                onClick={onOpen('franceConnect-configuration')}
                alternative
              >
