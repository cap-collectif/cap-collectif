  ...
  return (
    <Flex as="form" direction="column" spacing={3} id={formName}>
      ...
      <FormControl name="authorizationUrl" control={control} isRequired>
        <FormLabel htmlFor="authorizationUrl" label={intl.formatMessage({ id: 'authorization-URL' })} />
        <FieldInput
          id="authorizationUrl"
      ...
      <FormControl name="accessTokenUrl" control={control} isRequired>
        <FormLabel htmlFor="accessTokenUrl" label={intl.formatMessage({ id: 'access-token-URL' })} />
        <FieldInput
          id="accessTokenUrl"
          name="accessTokenUrl"
          control={control}
      ...
      <FormControl name="userInfoUrl" control={control} isRequired>
        <FormLabel htmlFor="userInfoUrl" label={intl.formatMessage({ id: 'user-information-url' })} />
        <FieldInput
          id="userInfoUrl"
          name="userInfoUrl"
          control={control}
      ...
      <FormControl name="logoutUrl" control={control} isRequired>
        <FormLabel htmlFor="logoutUrl" label={intl.formatMessage({ id: 'access-disconnection-url' })} />
        <FieldInput
          id="logoutUrl"
          name="logoutUrl"
          control={control}
      ...
      <FormControl name="profileUrl" control={control}>
        <FormLabel htmlFor="profileUrl" label={intl.formatMessage({ id: 'url-user-profile-sso' })} />
        <FieldInput
          id="profileUrl"
          name="profileUrl"
          control={control}
