...
const Shield: FC = () => {
    ...
    ) as ShieldQueryResponse['availableLocales'][0];
    ...
    const defaultValues = {
        introduction:
            shieldAdminForm.translations.find(
                translation => translation.locale === localeSelected.value,
            )?.introduction || '',
    ...
    return (
        <Accordion
            defaultAccordion="advanced-settings"
                        ...
                        <Switch
                            ...
                            onChange={() =>
                                toggleShield(
                                    ...
                                    shieldAdminForm.translations,
                                    shieldAdminForm?.media?.id,
                                )
                            }
                        />
                    </Flex>
