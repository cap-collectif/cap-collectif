  ...
  return (
    <Flex direction="column" bg="white" borderRadius="accordion" p={6} mt={6}>
      <Flex justify="space-between" alignItems="center" mb={isExternal ? 4 : 0}>
        ...
        <Switch id="isExternal" checked={isExternal} onChange={() => setValue('isExternal', !isExternal)} />
      </Flex>
      {isExternal ? (
        <Flex direction="column">
          ...
          <FormControl name="externalParticipantsCount" control={control}>
            ...
            <FieldInput width="100%" name="externalParticipantsCount" control={control} type="number" min={0} />
          </FormControl>
          <FormControl name="externalContributionsCount" control={control}>
            ...
            <FieldInput width="100%" name="externalContributionsCount" control={control} type="number" min={0} />
          </FormControl>
          <FormControl name="externalVotesCount" control={control}>
            ...
            <FieldInput width="100%" name="externalVotesCount" control={control} type="number" min={0} />
          </FormControl>
        </Flex>
      ) : null}
    </Flex>
