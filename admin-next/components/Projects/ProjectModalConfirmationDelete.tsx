...
const deleteProject = (projectId: string, hide: () => void, intl: IntlShape, connectionName: string) => {
  const input = {
    id: projectId,
  }
  hide()
      ...
      {({ hide }) => (
        <>
          ...
          <Modal.Body>
            ...
            <Checkbox id="isDeleteConfirmed" checked={confirm} onChange={() => setConfirm(!confirm)}>
