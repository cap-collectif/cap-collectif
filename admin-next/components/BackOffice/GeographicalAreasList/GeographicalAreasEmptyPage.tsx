...
import { Flex, Heading, SpotIcon, CapUISpotIcon, CapUISpotIconSize, CapUIIcon, Text, Button } from '@cap-collectif/ui'
  ...
  return (
    <Flex direction="row" spacing={8} bg="white" py="96px" px="111px" borderRadius="normal">
      ...
      <Flex direction="column" color="blue.900" align="flex-start" maxWidth="330px">
        ...
        <Button as="a" leftIcon={CapUIIcon.Add} href="/admin-next/geographical-area" variantSize="big">
