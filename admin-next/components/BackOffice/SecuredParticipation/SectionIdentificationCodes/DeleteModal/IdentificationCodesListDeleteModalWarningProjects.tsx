...
import { getProjectNamesUsingCodes, ProjectNamesUsingCodesQuery } from './GetProjectNamesUsingCodes'
...
const IdentificationCodesListDeleteModalWarningProjects: FC = () => {
  ...
  const projectsUsingCodes = useMemo(
    () => getProjectNamesUsingCodes(projects as GetProjectNamesUsingCodesQuery$data),
    [projects],
  )
