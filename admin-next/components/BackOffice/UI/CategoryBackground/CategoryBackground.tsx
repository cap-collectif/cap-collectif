...
const CategoryBackground: React.FC<CategoryBackgroundProps> = ({ color }) => {
  return (
    <svg id="background" height="100%" width="100%" viewBox="0 0 260 75" overflow="hidden" preserveAspectRatio="none">
      <defs>
        <filter
          x="-4.6%"
          y="-14.5%"
