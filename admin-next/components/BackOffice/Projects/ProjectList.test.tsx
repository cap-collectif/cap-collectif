        ...
        edges: [
          {
            node: {
              ...
              exportContributorsUrl: 'https://capco.dev/export-project-contributors/projectIdf3?_locale=fr-FR',
              exportableSteps: [
                {
                  position: 1,
                  step: {
                    ...
                    exportContributorsUrl: 'https://capco.dev/export-step-contributors/collectstepIdf3?_locale=fr-FR',
                  },
                  id: 'pasBp3Idf1',
                },
                {
                  ...
                  step: {
                    ...
                    title: 'Étape fermée, mais on peut modifier les réseaux sociaux des propositions',
                    exportStepUrl:
          ...
          },
          {
            node: {
              ...
              exportContributorsUrl: 'https://capco.dev/export-project-contributors/projectFood?_locale=fr-FR',
              exportableSteps: [
                {
                  position: 1,
                  step: {
          ...
          },
          {
            node: {
              ...
              exportContributorsUrl: 'https://capco.dev/export-project-contributors/projectArchived?_locale=fr-FR',
              exportableSteps: [],
              __typename: 'Project',
            },
          ...
          },
          {
            node: {
              ...
              exportContributorsUrl: 'https://capco.dev/export-project-contributors/projectConfinement?_locale=fr-FR',
              exportableSteps: [
                {
                  position: 1,
                  step: {
