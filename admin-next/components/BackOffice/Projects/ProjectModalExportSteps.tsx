...
import { Button, Modal, Heading, Text, ButtonGroup, Menu, CapUIModalSize, Box, FormLabel } from '@cap-collectif/ui'
import type {
  ProjectModalExportSteps_project$key,
  ProjectModalExportSteps_project$data,
...
`
const getSteptrad = (step: ProjectModalExportSteps_project$data['exportableSteps'][number]) => {
...
const ProjectModalExportSteps: React.FC<ProjectModalExportStepsProps> = ({ project: projectFragment }) => {
