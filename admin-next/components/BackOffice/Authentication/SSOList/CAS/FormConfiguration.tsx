  ...
  return (
    <Flex as="form" direction="column" spacing={3} id={formName}>
      <FormControl name="casVersion" control={control} isRequired>
        <FormLabel htmlFor="casVersion" label={capitalizeFirstLetter(intl.formatMessage({ id: 'app-version' }))} />
        <FieldInput
          type="select"
          control={control}
          name="casVersion"
      ...
      <FormControl name="casServerUrl" control={control} isRequired>
        <FormLabel htmlFor="casServerUrl" label={intl.formatMessage({ id: 'server-url' })} />
      ...
      <FormControl name="casCertificate" control={control} isRequired>
        <FormLabel htmlFor="casCertificate" label={intl.formatMessage({ id: 'server-certificate' })} />
        <FieldInput
          type="textarea"
          control={control}
          name="casCertificate"
      ...
      <Box as="label" htmlFor="casCertificateFileInput" color="blue.500" style={{ textDecoration: 'underline' }}>
