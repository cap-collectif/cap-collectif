      ...
      <FormControl name="secret" control={control} isRequired>
        ...
        <FieldInput
          ...
          rules={{
            validate: {
              equalTo: value =>
                value.length === 32 || intl.formatMessage({ id: 'facebook-app-secret-must-be-32-char' }),
            },
          }}
        />
      </FormControl>

      <Button as="a" variant="link" variantColor="primary" href="https://developers.facebook.com/apps/">
