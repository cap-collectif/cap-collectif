...
import QuestionnaireStepWithoutAccountRequirements from '@components/BackOffice/Requirements/QuestionnaireStepWithoutAccountRequirements'
        ...
        <Tabs
          ...
          onChange={selectedTab => {
            if (selectedTab !== voteType) {
              ...
              setValue('isAnonymousParticipationAllowed', isAnonymousParticipationAllowed)
            }
          }}
        >
          <Tabs.ButtonList ariaLabel="debateType">
            <Tabs.Button id={WITH_ACCOUNT}>{intl.formatMessage({ id: 'with-account' })}</Tabs.Button>
            <Tabs.Button id={WITHOUT_ACCOUNT}>{intl.formatMessage({ id: 'without-account' })}</Tabs.Button>
          </Tabs.ButtonList>
          <Tabs.PanelList>
            <Tabs.Panel>
              <Requirements requirementStep={questionnaireStep} />
            </Tabs.Panel>
            <Tabs.Panel>
