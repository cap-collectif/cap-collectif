                      ...
                      <ButtonQuickAction
                        ...
                        onClick={() => {
                          ...
                          const jumpIndex = questionsWithJumpsValues.findIndex((q: QuestionIds) => {
                            ...
                            if (q?.jumps) {
                              const isInCondition = q.jumps.some(jump =>
                                jump.conditions.some(condition => condition.question.id === questionsValues[index]?.id),
                              )
                              if (isInCondition) return true
                              const isInDestinationJump = q.jumps.some(
                                jump => jump.destination.id === questionsValues[index]?.id,
                              )
