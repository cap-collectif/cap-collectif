...
const HelpMessage: React.FC<Props> = ({ variant = 'info', children }) => {
  ...
  const getIcon = (variant: Variant, props?: any): React.ReactNode => {
    const common: { size: CapUIIconSize } = {
      size: CapUIIconSize.Md,
    }
    switch (variant) {
      case 'info':
        return <Icon name={CapUIIcon.Info} color="blue.500" {...common} {...props} />
      case 'success':
        return <Icon name={CapUIIcon.Check} color="green.500" {...common} {...props} />
      case 'danger':
        return <Icon name={CapUIIcon.Cross} color="red.500" {...common} {...props} />
      case 'warning':
        return <Icon name={CapUIIcon.Alert} color="yellow.500" {...common} {...props} />
      default:
