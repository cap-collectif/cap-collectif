...
const LoginChoices: React.FC<Props> = ({ selected }) => {
  ...
  const onFacebookClick = () => {
    ...
    window.location.href = getButtonLinkForType('facebook', redirectUri, false) ?? redirectUri
  }
  ...
  const onSSOClick = () => {
    ...
    const redirectUri = requirementsUrl
    window.location.href = getButtonLinkForType(type, redirectUri, false) ?? redirectUri
  }
