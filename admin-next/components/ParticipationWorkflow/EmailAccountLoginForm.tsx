...
import { Box, Button, CapInputSize, Flex, FormLabel, Text, useMultiStepModal, toast } from '@cap-collectif/ui'
import { FieldInput, FormControl } from '@cap-collectif/form'
import { useIntl, FormattedHTMLMessage } from 'react-intl'
import { useFormContext } from 'react-hook-form'
import useIsMobile from '@shared/hooks/useIsMobile'
import RetryLoginModal from './RetryLoginModal'
import ForgotPassword from './ForgotPassword'
import { MAGIC_LINK_FORM_INDEX } from './EmailMagicLinkForm'
...
const EmailAccountLoginForm: React.FC<Props> = ({ children }) => {
  ...
  const { handleSubmit, control, watch, setValue, setError, clearErrors } = useFormContext<FormValues>()
