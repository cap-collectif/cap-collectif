...
const FeatureList: FC = () => {
    ...
    const featureItemsFiltered = useMemo(() => getFeatureItemsFiltered(term, intl, allFeatureFlags, viewerSession.isSuperAdmin), [term, intl, allFeatureFlags, viewerSession.isSuperAdmin]);
                ...
                <Accordion defaultAccordion="general" allowMultiple>
                    {featureItemsFiltered.map(featureItem => (
                        <Accordion.Item id={featureItem.id} key={featureItem.id}>
                            <Accordion.Button>
                                {intl.formatMessage({ id: featureItem.title })}
                            </Accordion.Button>
                                            ...
                                            <Flex direction="column" flex={1} spacing={1}>
                                                <Flex direction="row" spacing={1}>
                                                    <Text {...headingStyles.h4} color="gray.900">
                                                        {intl.formatMessage({ id: group.title })}
                                                    </Text>
                                                        ...
                                                        <Flex
                                                            ...
                                                            <Flex direction="column" spacing={1}>
                                                                ...
                                                                <Flex direction="row" spacing={1}>
                                                                    ...
                                                                    {(featureFlagName.includes('unstable__') || featureFlagName.includes('beta__')) &&
                                                                        <Tag
                                                                            variantColor={featureFlagName.includes('unstable__') ? 'red' : 'yellow'}>
                                                                            <Tag.Label>
                                                                                {intl.formatMessage({ id: featureFlagName.includes('unstable__') ? 'work_in_progress' : 'global.beta' })}
                                                                            </Tag.Label>
                                                                        </Tag>}
                                                                </Flex>
                                                            ...
                                                            <Box flexShrink={0}>
                                                                <Switch
                                                                    ...
                                                                    onChange={(e) => toggleFeatureFlag(featureFlagName, e.target.checked, intl, setSaving)}
                                                                />
                                                            </Box>
                                                        </Flex>
                                                    ),
