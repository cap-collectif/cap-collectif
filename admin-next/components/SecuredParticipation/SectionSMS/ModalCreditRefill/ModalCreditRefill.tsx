                    ...
                    <Modal.Body>
                        <Flex direction="column" border="normal" align="center" borderColor="blue.200" bg="blue.100" p={6}>
                            <Text color="blue.900" mb={1}>
                                ...
                                <Text as="span" fontSize={3}>€ HT</Text>
                            </Text>

                            <Tag variantColor="green" maxWidth="100%">
                                <Tag.Label>
                                    {`${unitPriceSms}
                                    cts / ${intl.formatMessage({ id: "verified-participant" }).toLowerCase()} 
                                    (-${unitPriceSms * 100}%)`}
                                </Tag.Label>
                            </Tag>

                            <Text color="blue.800" fontSize={3} lineHeight={CapUILineHeight.S} maxWidth="70%" textAlign="center" my={5}>
                                {intl.formatMessage({ id: "choose-credit-pack-depend-of-participant" })}
                            </Text>
