...
import { SendEmailSVG } from '@components/Steps/CollectStep/assets/SendEmailSVG'
    ...
    >
      ...
      </Flex>
      {
        !collectByEmailFeatureFlag && (
          <Flex mt={3} borderRadius="4px" padding="16px" backgroundColor="#FAFCFF" height="128px" borderColor="#E0EFFF" alignItems="center"
                borderWidth="1px" gap={4}
          >
            <SendEmailSVG/>
            <Flex direction="column">
              <Text fontSize={CapUIFontSize.BodySmall} fontWeight={600}>{intl.formatMessage({ id: 'boost-participation-with-email' })}</Text>
              <Text fontSize={CapUIFontSize.BodySmall}>
                {intl.formatMessage({ id: 'proposal-collect-email-help-text-body' })}
              </Text>
              <Button as="a" target="_blank" href="https://aide.cap-collectif.com/article/379-participation-par-email" variant="tertiary">
