    ...
    <>
      ...
      <MultiStepModal.Body>
        <FormControl name={`${sectionFormKey}.title`} control={control} isRequired>
          <FormLabel htmlFor={`${sectionFormKey}.title`} label={intl.formatMessage({ id: 'global.title' })} />
          <FieldInput id={`${sectionFormKey}.title`} name={`${sectionFormKey}.title`} control={control} type="text" />
        </FormControl>
