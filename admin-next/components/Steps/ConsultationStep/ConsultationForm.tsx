...
import SectionsRecursive from '@components/Steps/ConsultationStep/SectionsRecursive';
import { UseFieldArrayRemove } from 'react-hook-form/dist/types/fieldArray';
import { getDefaultSection } from '@components/Steps/ConsultationStep/ConsultationStepForm';
                ...
                <Box ml={4} mb={4}>
                    ...
                    <Flex bg="white" p={6} justifyContent="space-between" borderRadius="4px" alignItems="center" spacing={4}>
                        <Flex width="100%" direction="column">
                            <FormControl
                                name={`${consultationFormKey}.title`}
                                control={control}
                                isRequired={true}
                                mb={6}>
                                <FormLabel
                            ...
                            <FormControl
                                name={`${consultationFormKey}.description`}
                                control={control}
                                isRequired={false}
                                mb={6}>
                                <FormLabel
