...
const QuestionnaireStepFormJumpsTab: React.FC = () => {
    const intl = useIntl();
                          ...
                          <ListCard.Item
                              ...
                              <Flex direction="column">
                                  <Text color="gray.500" fontSize={1} fontWeight={400}>
                                      {intl.formatMessage({
                                          id: isRedirection
                                              ? 'invitations-redirection.title'
                                              : 'jumps',
                                      })}
                                  </Text>
                                  <Text color="blue.900" fontSize={2} fontWeight={600}>
                                      {`${questionsWithJumpsValues[index].title} -> ${
                                          isRedirection
                                              ? questionsWithJumpsValues[index]
                                                    .alwaysJumpDestinationQuestion.title
                                              : intl.formatMessage(
                                                    {
                                                        id: 'jumps-number',
                                                    },
                                                    {
                                                        num: questionsWithJumpsValues[index].jumps
                                                            .length,
                                                    },
                                                )
                                      }`}
                              ...
                              <ButtonGroup>
                                  <ButtonQuickAction
                                      ...
                                      onClick={() => {
                                          ...
                                          setJumpIndex(index);
                                          onOpen(
                                              isRedirection ? 'redirection-modal' : 'jumps-modal',
                                          )();
                                      }}
                                      type="button"
                                  />
