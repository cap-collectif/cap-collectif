      ...
      {type === 'button' ? (
        <Flex justify="space-between" alignItems="flex-start" bg="white" p={4} mb={2} borderRadius="normal">
          ...
          <Switch
            ...
            onChange={() => setValue(`temporaryQuestion.responseColorsDisabled`, !responseColorsDisabled)}
          />
        </Flex>
      ) : null}
      {type === 'button' ? (
        <Flex justify="space-between" alignItems="flex-start" bg="white" p={4} mb={2} borderRadius="normal">
          ...
          <Switch
            ...
            onChange={() => setValue(`temporaryQuestion.groupedResponsesEnabled`, !groupedResponsesEnabled)}
          />
        </Flex>
      ) : null}
    </Flex>
