...
} from '@components/Steps/SelectStep/SelectStepForm';
import { SelectStepFormQueryResponse } from '@relay/SelectStepFormQuery.graphql';
import {getDefaultRequirements} from "../../Requirements/Requirements";

export const getDefaultValues = (
    step: SelectStepFormQueryResponse['step'],
    stepId: string,
    bgColor: string,
): FormValues => {
