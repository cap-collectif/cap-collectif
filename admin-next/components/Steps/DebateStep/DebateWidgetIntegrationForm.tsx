        ...
        <form>
            ...
            <Box>
                <Flex alignItems="center" mb={4}>
                    <FormLabel
                        label={intl.formatMessage({id: 'widget-appearance'})}
                    />
                    <Text ml={1} color="gray.500" >{intl.formatMessage({ id: 'global.optional' })}</Text>
                </Flex>
                <Flex mb={4} spacing={4}>
                ...
                <FormControl name="destinationLink" control={control}>
                    <Flex alignItems="center" spacing={1}>
                        <FormLabel
                            ...
                            label={intl.formatMessage({id: 'destination-link'})}
                        />
                ...
                <FormControl name="integrationCode" control={control}>
                    <Flex>
                        <FormLabel
                            ...
                            label={intl.formatMessage({id: 'integration-code'})}
                        />
