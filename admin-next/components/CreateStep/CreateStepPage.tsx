...
const CreateStepPage: React.FC<Props> = ({projectId}) => {
    ...
    return (
        <Flex>
            <Box bg="white" width="70%" p={6}
                 height="100%"
                 borderRadius="8px"
            >
                <Text fontWeight={600} color="blue.800"
                      fontSize={4}>{intl.formatMessage({id: 'select-step-type'})}</Text>
                <Flex
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Flex direction="column" ml={2}>
                                        <Text color="blue.800" fontSize={3}
                                              fontWeight="600">{step.heading}</Text>
                                        <Text color="gray.500" fontSize={3} lineHeight="initial">{step.description}</Text>
                                    </Flex>
                                </Flex>
                            )
                        })
