...
export const getInitialValues = (
  ...
  return {
    title: organization?.title || intl.formatMessage({ id: 'organisation.create.default.name' }),
...
export const getMemberList = (organization: OrganizationConfigFormMembers_organization$data): Member[] => {
  return [
