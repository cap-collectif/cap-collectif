            ...
            case 'QUESTIONNAIRE_ANALYSIS': {
                const hasQuestionnaire =
                    values.type === 'QUESTIONNAIRE'
                        ...
                        : analysisQuestionnairesCount > 0;
                const types = values.type === 'QUESTIONNAIRE' ? ['QUESTIONNAIRE', 'VOTING'] as Array<QuestionnaireType> : ['QUESTIONNAIRE_ANALYSIS'] as Array<QuestionnaireType>
                ...
                const response = await CreateProposalFormMutation.commit(
                    {
                        ...
                        connections: [
                            ConnectionHandler.getConnectionID(
                                owner.id,
                                'ProposalFormList_proposalForms',
                                {
                                    query: term || '',
                ...
                const response = await CreateConsultationMutation.commit(
                    {
                        ...
                        connections: [
                            ConnectionHandler.getConnectionID(
                                owner.id,
                                'ConsultationList_consultations',
                                {
                                    query: term || '',
                                    orderBy: { field: 'CREATED_AT', direction: orderBy },
                                },
