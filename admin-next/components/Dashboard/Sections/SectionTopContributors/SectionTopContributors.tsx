...
import { SectionTopContributorsQuery as SectionTopContributorsQueryType } from '@relay/SectionTopContributorsQuery.graphql'
...
const SectionTopContributors: FC<SectionTopContributorsProps> = ({ queryOptions }) => {
  const { filters } = useDashboard()
  const data = useLazyLoadQuery<SectionTopContributorsQueryType>(QUERY, getVariablesQuery(filters), queryOptions)
  const intl = useIntl()
