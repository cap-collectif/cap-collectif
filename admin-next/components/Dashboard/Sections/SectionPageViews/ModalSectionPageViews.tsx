...
const ModalSectionPageViews: FC<ModalSectionPageViewsProps> = ({ show, onClose, pageViews: pageViewsFragment }) => {
  ...
  return (
    <Modal
      show={show}
      onClose={onClose}
      ariaLabel={intl.formatMessage({ id: 'global.page.views.dynamic' }, { num: pageViews.totalCount })}
    ...
    >
      ...
      <Modal.Body spacing={5}>
        ...
        <InfoMessage variant="info">
          ...
          <InfoMessage.Content>{intl.formatMessage({ id: 'definition-page-views-word' })}</InfoMessage.Content>
        </InfoMessage>

        <LineChart
          data={formatValues(pageViews.values, intl)}
          label={intl.formatMessage({ id: 'global.page.views.dynamic' }, { num: pageViews.totalCount })}
          height="270px"
          withAxis
          withGrid
        />
